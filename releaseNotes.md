...
# Major Changes (49 changes)

**/api/v2/externalcontacts/contacts/{contactId}/associateconversation** (1 change)

* Path /api/v2/externalcontacts/contacts/{contactId}/associateconversation was removed

**DELETE /api/v2/outbound/sequences/{sequenceId}** (1 change)

* Response 200 type was changed from string to _undefined_
...
* Response 200 type was changed from DomainPhysicalInterface[] to PhysicalInterfaceEntityListing
...
* Parameter defaultRoleId was added
...
* Parameter webRtcUserId was added
...
**/api/v2/externalcontacts/contacts/schemas/{schemaId}** (3 changes)
...
* Enum value oUserPresences was added to property metrics
* Enum value oUserRoutingStatuses was added to property metrics
...
**VoicemailGroupPolicy** (2 changes)

* Optional property overflowGroupId was added
* Optional property groupAlertType was added

**Station** (1 change)

* Optional property webRtcUserId was added
...
**DELETE /api/v2/architect/prompts** (2 changes)
...
* Description was changed for parameter entityType
