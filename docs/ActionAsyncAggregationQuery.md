...
## ININ.PureCloudApi.Model.ActionAsyncAggregationQuery
...
| **Filter** | [**ActionAggregateQueryFilter**](ActionAggregateQueryFilter) | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters | [optional] |
