...
## ININ.PureCloudApi.Model.JourneyExternalEventsSchema
...
| **JsonSchema** | [**JourneyJsonSchemaDocument**](JourneyJsonSchemaDocument) | A JSON schema defining the extension to the built-in entity type. | [optional] |
