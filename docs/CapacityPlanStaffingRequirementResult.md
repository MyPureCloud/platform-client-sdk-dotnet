...
| **ReferenceBusinessUnitDate** | **String** | The reference date for interval-based data relative to the business unit time zone for the requirements. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd | |
