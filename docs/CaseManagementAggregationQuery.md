...
## ININ.PureCloudApi.Model.CaseManagementAggregationQuery
...
| **Filter** | [**CaseManagementAggregateQueryFilter**](CaseManagementAggregateQueryFilter) | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters | [optional] |
...
| **Views** | [**List&lt;CaseManagementAggregationView&gt;**](CaseManagementAggregationView) | Custom derived metric views | [optional] |
