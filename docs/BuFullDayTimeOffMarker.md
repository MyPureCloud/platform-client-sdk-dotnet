...
| **StartOffsetMinutes** | **int?** | The start offset in minutes for the time-off marker | [optional] |
| **EndOffsetMinutes** | **int?** | The end offset in minutes for the time-off marker | [optional] |
