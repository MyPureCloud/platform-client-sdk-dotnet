...
## ININ.PureCloudApi.Model.Coretype
...
| **DateCreated** | **DateTime?** | The date the core type was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z | [optional] |
