...
## ININ.PureCloudApi.Model.TaskManagementObservationGroupResult
...
| **StatusCategory** | **string** | The status category for this group. Present when group includes statusCategory. | [optional] |
