...
|------------ | ------------- | ------------- | -------------|
| **Type** | **string** | Screen module type. Required if support center is enabled | [optional] |
| **Enabled** | **bool?** | Whether or not knowledge portal (previously support center) screen module is enabled. If not provided, the module is treated as hidden | [optional] |
