...
## ININ.PureCloudApi.Model.QueueFullReference
...
| **ConditionalGroupActivation** | [**ConditionalGroupActivation**](ConditionalGroupActivation) | The Conditional Group Activation settings for the queue. | [optional] |
