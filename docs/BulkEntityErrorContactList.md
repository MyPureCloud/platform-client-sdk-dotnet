...
## ININ.PureCloudApi.Model.BulkEntityErrorContactList
...
| **Entity** | [**ContactList**](ContactList) | The entity body specified in the Bulk request operation that caused this error. | [optional] |
