...
## ININ.PureCloudApi.Model.AgentUtilizationAggregationQuery
...
| **Filter** | [**AgentUtilizationAggregateQueryFilter**](AgentUtilizationAggregateQueryFilter) | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters | [optional] |
...
| **Views** | [**List&lt;AgentUtilizationAggregationView&gt;**](AgentUtilizationAggregationView) | Custom derived metric views | [optional] |
