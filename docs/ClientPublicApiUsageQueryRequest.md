...
## ININ.PureCloudApi.Model.ClientPublicApiUsageQueryRequest
...
| **OrganizationIds** | **List&lt;string&gt;** | Specify if you only want a subset of organizationIds represented in the query. | [optional] |
