...
> [**EvaluationFormDivisionViewListing**](EvaluationFormDivisionViewListing) GetQualityPublishedformsEvaluationsDivisionviews (List<string> id, int? pageSize = null, int? pageNumber = null, string name = null, string divisionId = null)
...
namespace Example
{
    public class GetQualityPublishedformsEvaluationsDivisionviewsExample
    {
        ...
        { 
            ...
            var apiInstance = new QualityApi();
            var id = new List<string>(); // List<string> | A comma-delimited list of valid, published evaluation form ids
            var pageSize = 56;  // int? | Page size (optional)  (default to 25)
            var pageNumber = 56;  // int? | Page number (optional)  (default to 1)
            var name = name_example;  // string | Name (optional) 
            var divisionId = divisionId_example;  // string | divisionId (optional) 
...
> [**SurveyFormDivisionViewListing**](SurveyFormDivisionViewListing) GetQualityPublishedformsSurveysDivisionviews (List<string> id, int? pageSize = null, int? pageNumber = null, string name = null, string divisionId = null)
