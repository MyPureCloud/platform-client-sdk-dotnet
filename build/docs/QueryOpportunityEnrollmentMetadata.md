...
## ININ.PureCloudApi.Model.QueryOpportunityEnrollmentMetadata
...
| **DateReviewed** | **DateTime?** | The date the enrollment was reviewed. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z | [optional] |
