# JourneySchemaUpdateRequest

## ININ.PureCloudApi.Model.JourneySchemaUpdateRequest
...
| **JsonSchema** | [**JourneyJsonSchemaRequest**](JourneyJsonSchemaRequest) | A JSON schema defining the extension to the built-in entity type. | |
