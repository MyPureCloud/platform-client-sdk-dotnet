...
|------------ | ------------- | ------------- | -------------|
| **ParentSchema** | [**BusinessRulesParentSchemaRef**](BusinessRulesParentSchemaRef) | DSS schema entity defining source properties for the decision table contract schemas | [optional] |
