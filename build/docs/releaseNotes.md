...
**WhatsAppIntegrationUpdateRequest** (3 changes)
...
**GET /api/v2/integrations/actions/drafts** (4 changes)
...
**GET /api/v2/integrations/actions** (4 changes)
...
**POST /api/v2/recording/jobs** (3 changes)
