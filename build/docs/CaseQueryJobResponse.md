...
## ININ.PureCloudApi.Model.CaseQueryJobResponse
...
| **Error** | [**CaseQueryJobError**](CaseQueryJobError) | The error associated with the query job when the state is Failed. | [optional] |
