...
| **Shifts** | [**List&lt;WorkPlanShift&gt;**](WorkPlanShift) | Shifts in this work plan. Populate with expand&#x3D;details (defaults to empty list) | [optional] |
| **Agents** | [**List&lt;DeletableUserReference&gt;**](DeletableUserReference) | Agents in this work plan. Populate with expand&#x3D;details (defaults to empty list) | [optional] |
