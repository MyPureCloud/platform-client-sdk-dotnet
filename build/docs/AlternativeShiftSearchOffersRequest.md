---
title: AlternativeShiftSearchOffersRequest
---
...
| **InitiatingShift** | [**InitiatingAlternativeShift**](InitiatingAlternativeShift.html) | The shift a user puts up for alternative shift offers | |
