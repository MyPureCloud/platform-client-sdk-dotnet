...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public interface IMessagingApi : IApiAccessor
    {
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> PostMessagingIntegrationsLineWebhookIntegrationIdWithHttpInfo (string integrationId);
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task PostMessagingIntegrationsLineWebhookIntegrationIdAsync (string integrationId);
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> PostMessagingIntegrationsLineWebhookIntegrationIdAsyncWithHttpInfo (string integrationId);
    ...
    public partial class MessagingApi : IMessagingApi
    {
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns></returns>
        public void PostMessagingIntegrationsLineWebhookIntegrationId (string integrationId)
        {
             PostMessagingIntegrationsLineWebhookIntegrationIdWithHttpInfo(integrationId);
        }
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PostMessagingIntegrationsLineWebhookIntegrationIdWithHttpInfo (string integrationId)
        { 
            // verify the required parameter 'integrationId' is set
            if (integrationId == null)
                throw new ApiException(400, "Missing required parameter 'integrationId' when calling MessagingApi->PostMessagingIntegrationsLineWebhookIntegrationId");

            var localVarPath = "/api/v2/messaging/integrations/line/webhook/{integrationId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<Tuple<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostMessagingIntegrationsLineWebhookIntegrationId: " + localVarResponse.Content, localVarResponse.Content, localVarHeaders);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling PostMessagingIntegrationsLineWebhookIntegrationId: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostMessagingIntegrationsLineWebhookIntegrationIdAsync (string integrationId)
        {
             await PostMessagingIntegrationsLineWebhookIntegrationIdAsyncWithHttpInfo(integrationId);
        ...
        /// <param name="integrationId">Integration ID</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostMessagingIntegrationsLineWebhookIntegrationIdAsyncWithHttpInfo (string integrationId)
        { 
            // verify the required parameter 'integrationId' is set
            if (integrationId == null)
                throw new ApiException(400, "Missing required parameter 'integrationId' when calling MessagingApi->PostMessagingIntegrationsLineWebhookIntegrationId");
