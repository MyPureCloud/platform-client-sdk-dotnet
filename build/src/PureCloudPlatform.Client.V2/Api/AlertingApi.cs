...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public partial class AlertingApi : IAlertingApi
    {
        ...
        { 
            ...
            // Path params
            if (alertId != null) localVarPathParams.Add("alertId", Configuration.ApiClient.ParameterToString(alertId));
        ...
        { 
            ...
            // Path params
            if (ruleId != null) localVarPathParams.Add("ruleId", Configuration.ApiClient.ParameterToString(ruleId));
        ...
        { 
            ...
            return new ApiResponse<ActiveAlertCount>(localVarStatusCode,
                localVarHeaders,
                (ActiveAlertCount) Configuration.ApiClient.Deserialize(localVarResponse, typeof(ActiveAlertCount)));
