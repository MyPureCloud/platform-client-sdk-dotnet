...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public interface IWebChatApi : IApiAccessor
    {
        ...
        /// <returns>WebChatSettings</returns>
        WebChatSettings PostWebchatSettings (WebChatSettings body);
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>ApiResponse of WebChatSettings</returns>
        ApiResponse<WebChatSettings> PostWebchatSettingsWithHttpInfo (WebChatSettings body);
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>Task of WebChatSettings</returns>
        System.Threading.Tasks.Task<WebChatSettings> PostWebchatSettingsAsync (WebChatSettings body);
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>Task of ApiResponse (WebChatSettings)</returns>
        System.Threading.Tasks.Task<ApiResponse<WebChatSettings>> PostWebchatSettingsAsyncWithHttpInfo (WebChatSettings body);
    ...
    public partial class WebChatApi : IWebChatApi
    {
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>WebChatSettings</returns>
        public WebChatSettings PostWebchatSettings (WebChatSettings body)
        {
             ApiResponse<WebChatSettings> localVarResponse = PostWebchatSettingsWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>ApiResponse of WebChatSettings</returns>
        public ApiResponse< WebChatSettings > PostWebchatSettingsWithHttpInfo (WebChatSettings body)
        { 
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling WebChatApi->PostWebchatSettings");
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostWebchatSettings: " + localVarResponse.Content, localVarResponse.Content, localVarHeaders);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling PostWebchatSettings: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>Task of WebChatSettings</returns>
        public async System.Threading.Tasks.Task<WebChatSettings> PostWebchatSettingsAsync (WebChatSettings body)
        {
             ApiResponse<WebChatSettings> localVarResponse = await PostWebchatSettingsAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">webChatSettings</param>
        /// <returns>Task of ApiResponse (WebChatSettings)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<WebChatSettings>> PostWebchatSettingsAsyncWithHttpInfo (WebChatSettings body)
        { 
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling WebChatApi->PostWebchatSettings");
