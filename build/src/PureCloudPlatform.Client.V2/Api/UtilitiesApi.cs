...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public interface IUtilitiesApi : IApiAccessor
    {
        ...
        ApiResponse<Token> PostGmscTokensWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<Token> PostGmscTokensAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Token>> PostGmscTokensAsyncWithHttpInfo ();
    ...
    public partial class UtilitiesApi : IUtilitiesApi
    {
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Token</returns>
        public Token PostGmscTokens ()
        {
             ApiResponse<Token> localVarResponse = PostGmscTokensWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Token</returns>
        public ApiResponse< Token > PostGmscTokensWithHttpInfo ()
        { 

            var localVarPath = "/api/v2/gmsc/tokens";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<Tuple<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostGmscTokens: " + localVarResponse.Content, localVarResponse.Content, localVarHeaders);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling PostGmscTokens: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Token</returns>
        public async System.Threading.Tasks.Task<Token> PostGmscTokensAsync ()
        {
             ApiResponse<Token> localVarResponse = await PostGmscTokensAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Token)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Token>> PostGmscTokensAsyncWithHttpInfo ()
        { 
