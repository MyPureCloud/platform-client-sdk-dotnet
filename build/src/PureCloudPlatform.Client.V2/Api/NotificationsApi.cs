...
namespace PureCloudPlatform.Client.V2.Api
{
    ...
    public partial class NotificationsApi : INotificationsApi
    {
        ...
        /// <summary>
        /// Create a new channel There is a limit of 10 channels per user/app combination. Creating an 11th channel will remove the channel with oldest last used date.
        /// </summary>
        /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Channel</returns>
