    ...
    public static class NotificationTopics
    {
        ...
        static NotificationTopics()
        {
            ...
            { 
              ...
              {"v2.coaching.scheduleslots.jobs.{id}", typeof(WemCoachingScheduleSlotJobCompleteTopicCoachingScheduleSlotJobComplete)},
              ...
              {"v2.conversations.{id}.suggestions.thirdpartyaction", typeof(ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent)},
              ...
              {"v2.outbound.campaigns.{id}.skillstats", typeof(DialerCampaignSkillCombinationStatsEventCampaignSkillCombinationStats)},
              ...
              {"v2.outbound.schedules.emailcampaigns.{id}", typeof(EmailCampaignScheduleConfigChangeEmailCampaignSchedule)},
              {"v2.outbound.schedules.messagingcampaigns.{id}", typeof(MessagingCampaignScheduleConfigChangeMessagingCampaignSchedule)},
              {"v2.outbound.schedules.sequences.{id}", typeof(DialerSequenceScheduleConfigChangeSequenceSchedule)},
              {"v2.outbound.schedules.whatsappcampaigns.{id}", typeof(WhatsappCampaignScheduleConfigChangeWhatsAppCampaignSchedule)},
              ...
              {"v2.users.{id}.workforcemanagement.adherence.historical.agent", typeof(WfmHistoricalAdherenceAgentCalculationsCompleteTopicWfmHistoricalAdherenceAgentCalculationsCompleteNotification)},
              ...
              {"v2.users.{id}.workforcemanagement.agentschedules.managementunit.search.complete", typeof(WfmAgentMuScheduleSearchCompleteTopicAgentMuScheduleSearchCompleteNotification)},
              ...
              {"v2.users.{id}.workforcemanagement.decisionmetrics.jobs", typeof(DecisionMetricsAdminNotificationTopicDecisionMetricsJobNotification)},
              ...
              {"v2.users.{id}.workforcemanagement.shift.trading.jobs", typeof(WfmShiftTradingJobCompleteEventShiftTradingJobCompleteNotification)},
              ...
              {"v2.workforcemanagement.agents.opportunities", typeof(V2WfmAgentOpportunityTopicAgentOpportunityNotification)},
              ...
              {"v2.workforcemanagement.businessunits.{id}.activityplans.jobs", typeof(WfmActivityPlanJobCompleteTopicActivityPlanJobCompleteNotification)},
              {"v2.workforcemanagement.businessunits.{id}.activityplans.runs.jobs", typeof(WfmActivityPlanRunJobCompleteTopicActivityPlanJobCompleteNotification)},
              ...
              {"v2.workforcemanagement.managementunits.{id}.agentschedules.changed", typeof(WfmAgentManagementUnitScheduleChangedTopicAgentMuScheduleChangedNotification)},
