...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkitemsQueueEventsNotificationPropertyChange :  IEquatable<WorkitemsQueueEventsNotificationPropertyChange>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkitemsQueueEventsNotificationPropertyChange" /> class.
        /// </summary>
        /// <param name="Property">Property.</param>
        /// <param name="OldValues">OldValues.</param>
        /// <param name="NewValues">NewValues.</param>
        public WorkitemsQueueEventsNotificationPropertyChange(string Property = null, List<string> OldValues = null, List<string> NewValues = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkitemsQueueEventsNotificationPropertyChange);
        }

        /// <summary>
        /// Returns true if WorkitemsQueueEventsNotificationPropertyChange instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkitemsQueueEventsNotificationPropertyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkitemsQueueEventsNotificationPropertyChange other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
