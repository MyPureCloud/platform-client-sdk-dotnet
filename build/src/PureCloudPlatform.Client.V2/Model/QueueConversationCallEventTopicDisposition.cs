...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class QueueConversationCallEventTopicDisposition : IEquatable<QueueConversationCallEventTopicDisposition>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="QueueConversationCallEventTopicDisposition" /> class.
		/// </summary>
		...
		public QueueConversationCallEventTopicDisposition(string Name = null, string Analyzer = null, QueueConversationCallEventTopicDispositionAmdTimeout AmdTimeout = null, QueueConversationCallEventTopicDispositionSilentCallTimeout SilentCallTimeout = null)
		{
			this.Name = Name;
		...
		public QueueConversationCallEventTopicDispositionAmdTimeout AmdTimeout { get; set; }
		...
		public QueueConversationCallEventTopicDispositionSilentCallTimeout SilentCallTimeout { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as QueueConversationCallEventTopicDisposition);
		}

		/// <summary>
		/// Returns true if QueueConversationCallEventTopicDisposition instances are equal
		/// </summary>
		/// <param name="other">Instance of QueueConversationCallEventTopicDisposition to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(QueueConversationCallEventTopicDisposition other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
