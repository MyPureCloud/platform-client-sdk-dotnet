...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class HeartBeatAlertNotification :  IEquatable<HeartBeatAlertNotification>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HeartBeatAlertNotification);
        }

        /// <summary>
        /// Returns true if HeartBeatAlertNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of HeartBeatAlertNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HeartBeatAlertNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
