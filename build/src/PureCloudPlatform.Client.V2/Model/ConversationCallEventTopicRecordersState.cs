...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationCallEventTopicRecordersState : IEquatable<ConversationCallEventTopicRecordersState>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationCallEventTopicRecordersState" /> class.
		/// </summary>
		...
		public override string ToString()
		{
			...
			sb.Append("class ConversationCallEventTopicRecordersState {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationCallEventTopicRecordersState);
		}

		/// <summary>
		/// Returns true if ConversationCallEventTopicRecordersState instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationCallEventTopicRecordersState to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationCallEventTopicRecordersState other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
