...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentUtilizationAsyncAggregationQuery :  IEquatable<AgentUtilizationAsyncAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUtilizationAsyncAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentUtilizationAsyncAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUtilizationAsyncAggregationQuery" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentUtilizationAsyncAggregationQuery);
        }

        /// <summary>
        /// Returns true if AgentUtilizationAsyncAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentUtilizationAsyncAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentUtilizationAsyncAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
