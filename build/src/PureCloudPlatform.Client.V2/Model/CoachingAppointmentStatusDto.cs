...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CoachingAppointmentStatusDto :  IEquatable<CoachingAppointmentStatusDto>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CoachingAppointmentStatusDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoachingAppointmentStatusDto() { }
        ...
        public CoachingAppointmentStatusDto(CoachingAppointmentReference Appointment = null, UserReference CreatedBy = null, StatusEnum? Status = null)
        {
        ...
        /// </summary>
        /// <value>Creation time of the status. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CoachingAppointmentStatusDto);
        }

        /// <summary>
        /// Returns true if CoachingAppointmentStatusDto instances are equal
        /// </summary>
        /// <param name="other">Instance of CoachingAppointmentStatusDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoachingAppointmentStatusDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
