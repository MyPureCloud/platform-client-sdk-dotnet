...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema :  IEquatable<BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema" /> class.
        /// </summary>
        ...
        public BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema(List<BuPlanningGroupHeadcountForecastUploadSchema> Entities = null, DateTime? ReferenceStartDate = null)
        {
        ...
        public List<BuPlanningGroupHeadcountForecastUploadSchema> Entities { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema);
        }

        /// <summary>
        /// Returns true if BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema instances are equal
        /// </summary>
        /// <param name="other">Instance of BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuHeadcountForecastBuPlanningGroupHeadcountForecastUploadSchema other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
