...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationErrorDetails :  IEquatable<ConversationNotificationErrorDetails>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationNotificationErrorDetails" /> class.
        /// </summary>
        ...
        public ConversationNotificationErrorDetails(int? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, string Uri = null, Object AdditionalProperties = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationErrorDetails);
        }

        /// <summary>
        /// Returns true if ConversationNotificationErrorDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationErrorDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationErrorDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
