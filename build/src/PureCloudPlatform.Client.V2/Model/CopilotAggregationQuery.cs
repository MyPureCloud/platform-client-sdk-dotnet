...
{
    /// <summary>
    /// CopilotAggregationQuery
    /// </summary>
    [DataContract]
    public partial class CopilotAggregationQuery :  IEquatable<CopilotAggregationQuery>
    {
        /// <summary>
        ...
        public enum GroupByEnum
        {
            ...
            /// <summary>
            /// Enum Toolid for "toolId"
            /// </summary>
            [EnumMember(Value = "toolId")]
            Toolid,
            
            /// <summary>
            /// Enum Toolstatus for "toolStatus"
            /// </summary>
            [EnumMember(Value = "toolStatus")]
            Toolstatus,
            
            /// <summary>
            /// Enum Tooltype for "toolType"
            /// </summary>
            [EnumMember(Value = "toolType")]
            Tooltype,
        ...
        public enum MetricsEnum
        {
            ...
            /// <summary>
            /// Enum Ncopilotmessages for "nCopilotMessages"
            /// </summary>
            [EnumMember(Value = "nCopilotMessages")]
            Ncopilotmessages,
            
            /// <summary>
            /// Enum Ncopilotsessions for "nCopilotSessions"
            /// </summary>
            [EnumMember(Value = "nCopilotSessions")]
            Ncopilotsessions,
            
            /// <summary>
            /// Enum Ncopilottoolinvocations for "nCopilotToolInvocations"
            /// </summary>
            [EnumMember(Value = "nCopilotToolInvocations")]
            Ncopilottoolinvocations,
            
            /// <summary>
            /// Enum Ncopilotusers for "nCopilotUsers"
            /// </summary>
            [EnumMember(Value = "nCopilotUsers")]
            Ncopilotusers
        }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CopilotAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CopilotAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CopilotAggregationQuery" /> class.
        /// </summary>
        ...
        public CopilotAggregationQuery(string Interval = null, string Granularity = null, string TimeZone = null, List<GroupByEnum> GroupBy = null, CopilotAggregateQueryFilter Filter = null, List<MetricsEnum> Metrics = null, bool? FlattenMultivaluedDimensions = null, List<CopilotAggregationView> Views = null, AlternateTimeDimensionEnum? AlternateTimeDimension = null)
        {
        ...
        public CopilotAggregateQueryFilter Filter { get; set; }
        ...
        public List<CopilotAggregationView> Views { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CopilotAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CopilotAggregationQuery);
        }

        /// <summary>
        /// Returns true if CopilotAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of CopilotAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CopilotAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
