...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AcwSettings :  IEquatable<AcwSettings>
    {
        ...
        /// <param name="TimeoutMs">The amount of time the agent can stay in ACW (Min: 1 sec, Max: 15 min).  Can only be used when ACW is MANDATORY_TIMEOUT or MANDATORY_FORCED_TIMEOUT..</param>
        ...
        /// </summary>
        /// <value>The amount of time the agent can stay in ACW (Min: 1 sec, Max: 15 min).  Can only be used when ACW is MANDATORY_TIMEOUT or MANDATORY_FORCED_TIMEOUT.</value>
