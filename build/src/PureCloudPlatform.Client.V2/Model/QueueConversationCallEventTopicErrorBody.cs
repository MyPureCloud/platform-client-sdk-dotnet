...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationCallEventTopicErrorBody :  IEquatable<QueueConversationCallEventTopicErrorBody>
    {
        ...
        public QueueConversationCallEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<QueueConversationCallEventTopicDetail> Details = null, List<QueueConversationCallEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
