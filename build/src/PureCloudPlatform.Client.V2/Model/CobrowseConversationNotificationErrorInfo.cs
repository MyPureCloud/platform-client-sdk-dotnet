...
{
    /// <summary>
    /// CobrowseConversationNotificationErrorInfo
    /// </summary>
    [DataContract]
    public partial class CobrowseConversationNotificationErrorInfo :  IEquatable<CobrowseConversationNotificationErrorInfo>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CobrowseConversationNotificationErrorInfo" /> class.
        /// </summary>
        ...
        public CobrowseConversationNotificationErrorInfo(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<CobrowseConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public List<CobrowseConversationNotificationErrorBody> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CobrowseConversationNotificationErrorInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CobrowseConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if CobrowseConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CobrowseConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CobrowseConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
