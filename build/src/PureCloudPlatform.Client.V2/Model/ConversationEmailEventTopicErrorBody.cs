...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationEmailEventTopicErrorBody :  IEquatable<ConversationEmailEventTopicErrorBody>
    {
        ...
        public ConversationEmailEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationEmailEventTopicDetail> Details = null, List<ConversationEmailEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
