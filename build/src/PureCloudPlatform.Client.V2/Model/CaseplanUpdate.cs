...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CaseplanUpdate :  IEquatable<CaseplanUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseplanUpdate" /> class.
        /// </summary>
        /// <param name="Name">The name of the Caseplan. Valid length between 3 and 256 characters..</param>
        ...
        /// <param name="ReferencePrefix">The reference of the Caseplan. Valid length between 2 and 8 alphanumeric characters..</param>
        /// <param name="CustomerIntentId">The ID of the customer intent associated with this Caseplan..</param>
        /// <param name="Description">The description of the Caseplan. Maximum length of 512 characters..</param>
        /// <param name="DefaultCaseOwnerId">The ID of the default owner of a Case created from the Caseplan. Must be a valid UUID..</param>
        /// <param name="DivisionId">The ID of the division the Caseplan belongs to. If divisionId is null or &#39;*&#39;, the Caseplan will be divisionless..</param>
        public CaseplanUpdate(string Name = null, int? DefaultDueDurationInSeconds = null, int? DefaultTtlSeconds = null, string ReferencePrefix = null, string CustomerIntentId = null, string Description = null, string DefaultCaseOwnerId = null, string DivisionId = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The reference of the Caseplan. Valid length between 2 and 8 alphanumeric characters.</value>
        ...
        /// </summary>
        /// <value>The ID of the default owner of a Case created from the Caseplan. Must be a valid UUID.</value>
        ...
        /// </summary>
        /// <value>The ID of the division the Caseplan belongs to. If divisionId is null or &#39;*&#39;, the Caseplan will be divisionless.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CaseplanUpdate);
        }

        /// <summary>
        /// Returns true if CaseplanUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of CaseplanUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseplanUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
