...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmTimeSpan :  IEquatable<WfmTimeSpan>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="WfmTimeSpan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WfmTimeSpan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmTimeSpan" /> class.
        /// </summary>
        ...
        public WfmTimeSpan(DateTime? StartDate = null, int? LengthMinutes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmTimeSpan);
        }

        /// <summary>
        /// Returns true if WfmTimeSpan instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmTimeSpan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmTimeSpan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
