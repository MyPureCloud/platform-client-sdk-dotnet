...
{
    /// <summary>
    /// CaseManagementAggregationQuery
    /// </summary>
    [DataContract]
    public partial class CaseManagementAggregationQuery :  IEquatable<CaseManagementAggregationQuery>
    {
        /// <summary>
        ...
        public enum GroupByEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "customerIntentId")]
            Customerintentid,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseManagementAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaseManagementAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseManagementAggregationQuery" /> class.
        /// </summary>
        ...
        public CaseManagementAggregateQueryFilter Filter { get; set; }
        ...
        public List<CaseManagementAggregationView> Views { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaseManagementAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CaseManagementAggregationQuery);
        }

        /// <summary>
        /// Returns true if CaseManagementAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of CaseManagementAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseManagementAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
