...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FacebookIdentityResolutionConfig :  IEquatable<FacebookIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="FacebookIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FacebookIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FacebookIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public FacebookIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FacebookIdentityResolutionConfig {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FacebookIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if FacebookIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of FacebookIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FacebookIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
