...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HeartBeatRuleNotification :  IEquatable<HeartBeatRuleNotification>
    {
...
this.RuleType = RuleType;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HeartBeatRuleNotification);
        }

        /// <summary>
        /// Returns true if HeartBeatRuleNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of HeartBeatRuleNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HeartBeatRuleNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
