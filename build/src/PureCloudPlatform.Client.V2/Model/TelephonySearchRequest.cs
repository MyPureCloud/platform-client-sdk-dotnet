...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TelephonySearchRequest :  IEquatable<TelephonySearchRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TelephonySearchRequest" /> class.
        /// </summary>
        ...
        public TelephonySearchRequest(SortOrderEnum? SortOrder = null, string SortBy = null, int? PageSize = null, int? PageNumber = null, List<SearchSort> Sort = null, List<string> Expand = null, List<TelephonySearchCriteria> Query = null)
        {
        ...
        public List<TelephonySearchCriteria> Query { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TelephonySearchRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TelephonySearchRequest);
        }

        /// <summary>
        /// Returns true if TelephonySearchRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TelephonySearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelephonySearchRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
