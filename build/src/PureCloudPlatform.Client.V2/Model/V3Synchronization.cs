...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3Synchronization :  IEquatable<V3Synchronization>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3Synchronization" /> class.
        /// </summary>
        /// <param name="Type">The type of the synchronization..</param>
        /// <param name="CreatedBy">The user who started the synchronization if the source is manually synchronized or the user who created the source for scheduled synchronization..</param>
        /// <param name="Source">The source of the synchronization..</param>
        ...
        public V3Synchronization(TypeEnum? Type = null, UserReference CreatedBy = null, V3SourceRef Source = null, DateTime? DateStart = null, DateTime? DateEnd = null, DateTime? DateSourceIntervalStart = null, DateTime? DateSourceIntervalEnd = null, TriggerTypeEnum? TriggerType = null, StatusEnum? Status = null, V3SynchronizationStatistics Statistics = null, ErrorBody Error = null, IngestionStatusEnum? IngestionStatus = null)
        {
            this.Type = Type;
        ...
        /// </summary>
        /// <value>The user who started the synchronization if the source is manually synchronized or the user who created the source for scheduled synchronization.</value>
        ...
        /// </summary>
        /// <value>The source of the synchronization.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3Synchronization);
        }

        /// <summary>
        /// Returns true if V3Synchronization instances are equal
        /// </summary>
        /// <param name="other">Instance of V3Synchronization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Synchronization other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
