...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CaseQueryJobResponse :  IEquatable<CaseQueryJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseQueryJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="Error">The error associated with the query job when the state is Failed..</param>
        public CaseQueryJobResponse(StateEnum? State = null, DateTime? DateStarted = null, DateTime? DateFinished = null, CaseQueryJobError Error = null)
        {
            this.State = State;
        ...
        /// </summary>
        /// <value>The error associated with the query job when the state is Failed.</value>
        [DataMember(Name="error", EmitDefaultValue=false)]
        public CaseQueryJobError Error { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CaseQueryJobResponse);
        }

        /// <summary>
        /// Returns true if CaseQueryJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CaseQueryJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseQueryJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
