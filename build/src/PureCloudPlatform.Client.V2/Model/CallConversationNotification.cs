...
this.RecordingState = RecordingState;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallConversationNotification);
        }

        /// <summary>
        /// Returns true if CallConversationNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of CallConversationNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallConversationNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
