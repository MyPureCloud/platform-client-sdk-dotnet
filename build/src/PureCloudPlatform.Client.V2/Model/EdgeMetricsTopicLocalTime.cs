...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdgeMetricsTopicLocalTime :  IEquatable<EdgeMetricsTopicLocalTime>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeMetricsTopicLocalTime" /> class.
        /// </summary>
        /// <param name="Hour">Hour.</param>
        /// <param name="Minute">Minute.</param>
        /// <param name="Second">Second.</param>
        /// <param name="Nano">Nano.</param>
        public EdgeMetricsTopicLocalTime(int? Hour = null, int? Minute = null, int? Second = null, int? Nano = null)
        {
            this.Hour = Hour;
            this.Minute = Minute;
            this.Second = Second;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EdgeMetricsTopicLocalTime);
        }

        /// <summary>
        /// Returns true if EdgeMetricsTopicLocalTime instances are equal
        /// </summary>
        /// <param name="other">Instance of EdgeMetricsTopicLocalTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeMetricsTopicLocalTime other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
