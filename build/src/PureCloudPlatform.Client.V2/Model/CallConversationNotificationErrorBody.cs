...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallConversationNotificationErrorBody :  IEquatable<CallConversationNotificationErrorBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallConversationNotificationErrorBody" /> class.
        /// </summary>
        ...
        public CallConversationNotificationErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<CallConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallConversationNotificationErrorBody);
        }

        /// <summary>
        /// Returns true if CallConversationNotificationErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of CallConversationNotificationErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallConversationNotificationErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
