...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationFormPage : IEquatable<ConversationFormPage>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationFormPage" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected ConversationFormPage() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationFormPage" /> class.
		/// </summary>
		/// <param name="Title">Text to show in the title. (required).</param>
		/// <param name="Subtitle">Text to show in the subtitle. (required).</param>
		/// <param name="PageComponents">Page components in this form page..</param>
		public ConversationFormPage(string Title = null, string Subtitle = null, List<ConversationFormPageComponent> PageComponents = null)
		{
			this.Title = Title;
		...
		public List<ConversationFormPageComponent> PageComponents { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationFormPage);
		}

		/// <summary>
		/// Returns true if ConversationFormPage instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationFormPage to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationFormPage other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
