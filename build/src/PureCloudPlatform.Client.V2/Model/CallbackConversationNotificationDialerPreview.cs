...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackConversationNotificationDialerPreview :  IEquatable<CallbackConversationNotificationDialerPreview>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackConversationNotificationDialerPreview" /> class.
        /// </summary>
        ...
        public CallbackConversationNotificationDialerPreview(string Id = null, string ContactId = null, string ContactListId = null, string CampaignId = null, List<CampaignNotificationPhoneColumns> PhoneNumberColumns = null, Object AdditionalProperties = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallbackConversationNotificationDialerPreview);
        }

        /// <summary>
        /// Returns true if CallbackConversationNotificationDialerPreview instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackConversationNotificationDialerPreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackConversationNotificationDialerPreview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
