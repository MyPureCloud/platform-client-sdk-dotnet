...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class FlowExecutionAggregationSort : IEquatable<FlowExecutionAggregationSort>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FlowExecutionAggregationSort" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected FlowExecutionAggregationSort() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="FlowExecutionAggregationSort" /> class.
		/// </summary>
		...
		public FlowExecutionAggregationSort(NameEnum? Name = null, FunctionEnum? Function = null)
		{
			this.Name = Name;
		...
		public override string ToString()
		{
			...
			sb.Append("class FlowExecutionAggregationSort {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as FlowExecutionAggregationSort);
		}

		/// <summary>
		/// Returns true if FlowExecutionAggregationSort instances are equal
		/// </summary>
		/// <param name="other">Instance of FlowExecutionAggregationSort to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(FlowExecutionAggregationSort other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
