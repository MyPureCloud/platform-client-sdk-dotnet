...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationIntentSuggestionsTopicSuggestedIntent : IEquatable<ConversationIntentSuggestionsTopicSuggestedIntent>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationIntentSuggestionsTopicSuggestedIntent" /> class.
		/// </summary>
		/// <param name="Intent">Intent.</param>
		/// <param name="IntentId">IntentId.</param>
		/// <param name="Confidence">Confidence.</param>
		/// <param name="DetectedSlots">DetectedSlots.</param>
		public ConversationIntentSuggestionsTopicSuggestedIntent(string Intent = null, string IntentId = null, double? Confidence = null, List<ConversationIntentSuggestionsTopicSuggestedIntentSlot> DetectedSlots = null)
		{
			this.Intent = Intent;
		...
		public List<ConversationIntentSuggestionsTopicSuggestedIntentSlot> DetectedSlots { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationIntentSuggestionsTopicSuggestedIntent);
		}

		/// <summary>
		/// Returns true if ConversationIntentSuggestionsTopicSuggestedIntent instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationIntentSuggestionsTopicSuggestedIntent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationIntentSuggestionsTopicSuggestedIntent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
