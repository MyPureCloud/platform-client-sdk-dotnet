...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicDispositionAmdTimeout :  IEquatable<QueueConversationVideoEventTopicDispositionAmdTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicDispositionAmdTimeout" /> class.
        /// </summary>
        ...
        public QueueConversationVideoEventTopicDispositionAmdTimeout(long? TimeoutMs = null, string TimerStartEvent = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationVideoEventTopicDispositionAmdTimeout {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicDispositionAmdTimeout);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicDispositionAmdTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicDispositionAmdTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicDispositionAmdTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
