...
{
    /// <summary>
    /// ConversationCallEventTopicDisposition
    /// </summary>
    [DataContract]
    public partial class ConversationCallEventTopicDisposition :  IEquatable<ConversationCallEventTopicDisposition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCallEventTopicDisposition" /> class.
        /// </summary>
        ...
        public ConversationCallEventTopicDisposition(string Name = null, string Analyzer = null, ConversationCallEventTopicDispositionAmdTimeout AmdTimeout = null, ConversationCallEventTopicDispositionSilentCallTimeout SilentCallTimeout = null)
        {
            this.Name = Name;
        ...
        public ConversationCallEventTopicDispositionAmdTimeout AmdTimeout { get; set; }
        ...
        public ConversationCallEventTopicDispositionSilentCallTimeout SilentCallTimeout { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationCallEventTopicDisposition {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallEventTopicDisposition);
        }

        /// <summary>
        /// Returns true if ConversationCallEventTopicDisposition instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallEventTopicDisposition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallEventTopicDisposition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
