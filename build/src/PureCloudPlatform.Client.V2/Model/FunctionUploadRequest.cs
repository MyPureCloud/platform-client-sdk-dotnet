...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class FunctionUploadRequest :  IEquatable<FunctionUploadRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="FunctionUploadRequest" /> class.
        /// </summary>
        /// <param name="FileName">Name of the file to upload.File name can only contain letters, numbers, spaces, and the following special characters: + - _ . ( ) (required).</param>
        ...
        /// </summary>
        /// <value>Name of the file to upload.File name can only contain letters, numbers, spaces, and the following special characters: + - _ . ( )</value>
