...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduleVisibilitySettingsRequest :  IEquatable<ScheduleVisibilitySettingsRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleVisibilitySettingsRequest" /> class.
        /// </summary>
        /// <param name="Enabled">Whether schedule visibility controls are enabled for this management unit.</param>
        /// <param name="FutureWeeks">The number of weeks into the future that agents can see schedules in this management unit. 0 means current week.</param>
        public ScheduleVisibilitySettingsRequest(bool? Enabled = null, int? FutureWeeks = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ScheduleVisibilitySettingsRequest);
        }

        /// <summary>
        /// Returns true if ScheduleVisibilitySettingsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ScheduleVisibilitySettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleVisibilitySettingsRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
