...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackConversationNotificationVoicemail :  IEquatable<CallbackConversationNotificationVoicemail>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallbackConversationNotificationVoicemail);
        }

        /// <summary>
        /// Returns true if CallbackConversationNotificationVoicemail instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackConversationNotificationVoicemail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackConversationNotificationVoicemail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
