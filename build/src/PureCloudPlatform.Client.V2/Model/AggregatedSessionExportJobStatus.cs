...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregatedSessionExportJobStatus :  IEquatable<AggregatedSessionExportJobStatus>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregatedSessionExportJobStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AggregatedSessionExportJobStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregatedSessionExportJobStatus" /> class.
        /// </summary>
        ...
        public AggregatedSessionExportJobStatus(string Id = null, StatusEnum? Status = null, string DownloadUrl = null, CsvExportErrorDetails Error = null)
        {
            this.Id = Id;
            this.Status = Status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AggregatedSessionExportJobStatus {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AggregatedSessionExportJobStatus);
        }

        /// <summary>
        /// Returns true if AggregatedSessionExportJobStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of AggregatedSessionExportJobStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregatedSessionExportJobStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
