...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class OutboundRouteBase :  IEquatable<OutboundRouteBase>
    {
        ...
        public OutboundRouteBase(string Name = null, string Description = null, int? Version = null, DateTime? DateCreated = null, DateTime? DateModified = null, string ModifiedBy = null, string CreatedBy = null, StateEnum? State = null, string ModifiedByApp = null, string CreatedByApp = null, List<string> ClassificationTypes = null, bool? Enabled = null, DistributionEnum? Distribution = null, List<UriReference> ExternalTrunkBases = null)
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for OutboundRouteBase and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            {
                throw new InvalidDataException("ClassificationTypes is a required property for OutboundRouteBase and cannot be null");
            }
            else
            {
