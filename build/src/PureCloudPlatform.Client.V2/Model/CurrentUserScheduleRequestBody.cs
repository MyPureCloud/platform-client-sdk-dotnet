...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CurrentUserScheduleRequestBody :  IEquatable<CurrentUserScheduleRequestBody>
    {
        ...
        public CurrentUserScheduleRequestBody(DateTime? StartDate = null, DateTime? EndDate = null)
        {
            ...
            if (StartDate == null)
            {
                throw new InvalidDataException("StartDate is a required property for CurrentUserScheduleRequestBody and cannot be null");
            }
            else
            {
            ...
            if (EndDate == null)
            {
                throw new InvalidDataException("EndDate is a required property for CurrentUserScheduleRequestBody and cannot be null");
            }
            else
            {
