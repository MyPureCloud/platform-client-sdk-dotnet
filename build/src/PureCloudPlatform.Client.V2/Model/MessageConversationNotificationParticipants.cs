...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageConversationNotificationParticipants :  IEquatable<MessageConversationNotificationParticipants>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageConversationNotificationParticipants" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if MessageConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
