...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationSocialExpressionEventTopicWrapup :  IEquatable<ConversationSocialExpressionEventTopicWrapup>
    {
        ...
        public ConversationSocialExpressionEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, int? DurationSeconds = null, DateTime? EndTime = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
