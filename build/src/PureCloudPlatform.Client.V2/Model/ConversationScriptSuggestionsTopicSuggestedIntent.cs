...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationScriptSuggestionsTopicSuggestedIntent : IEquatable<ConversationScriptSuggestionsTopicSuggestedIntent>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationScriptSuggestionsTopicSuggestedIntent" /> class.
		/// </summary>
		/// <param name="Intent">Intent.</param>
		/// <param name="IntentId">IntentId.</param>
		/// <param name="Confidence">Confidence.</param>
		/// <param name="DetectedSlots">DetectedSlots.</param>
		public ConversationScriptSuggestionsTopicSuggestedIntent(string Intent = null, string IntentId = null, double? Confidence = null, List<ConversationScriptSuggestionsTopicSuggestedIntentSlot> DetectedSlots = null)
		{
			this.Intent = Intent;
		...
		public List<ConversationScriptSuggestionsTopicSuggestedIntentSlot> DetectedSlots { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationScriptSuggestionsTopicSuggestedIntent);
		}

		/// <summary>
		/// Returns true if ConversationScriptSuggestionsTopicSuggestedIntent instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationScriptSuggestionsTopicSuggestedIntent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationScriptSuggestionsTopicSuggestedIntent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
