...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationContentGeneric :  IEquatable<ConversationContentGeneric>
    {
        /// <summary>
        ...
        public List<ConversationButtonComponent> Components { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationContentGeneric);
        }

        /// <summary>
        /// Returns true if ConversationContentGeneric instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationContentGeneric to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationContentGeneric other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
