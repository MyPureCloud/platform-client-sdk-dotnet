...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallableTimeSetNotificationCallableTimes :  IEquatable<CallableTimeSetNotificationCallableTimes>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallableTimeSetNotificationCallableTimes);
        }

        /// <summary>
        /// Returns true if CallableTimeSetNotificationCallableTimes instances are equal
        /// </summary>
        /// <param name="other">Instance of CallableTimeSetNotificationCallableTimes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallableTimeSetNotificationCallableTimes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
