...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class DocumentationSearchCriteria :  IEquatable<DocumentationSearchCriteria>
    {
        ...
        public DocumentationSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, List<string> Fields = null, string Value = null, OperatorEnum? _Operator = null, List<DocumentationSearchCriteria> Group = null, TypeEnum? Type = null)
        {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for DocumentationSearchCriteria and cannot be null");
            }
            else
            {
                this.Type = Type;
