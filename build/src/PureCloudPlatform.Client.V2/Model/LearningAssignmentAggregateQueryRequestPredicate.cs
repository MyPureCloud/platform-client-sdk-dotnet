...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class LearningAssignmentAggregateQueryRequestPredicate :  IEquatable<LearningAssignmentAggregateQueryRequestPredicate>
    {
        ...
        /// <param name="Value">Corresponding value for dimensions in predicates. If the dimensions is type, Valid Values: Informational, AssessedContent, Questionnaire (required).</param>
        ...
        /// </summary>
        /// <value>Corresponding value for dimensions in predicates. If the dimensions is type, Valid Values: Informational, AssessedContent, Questionnaire</value>
