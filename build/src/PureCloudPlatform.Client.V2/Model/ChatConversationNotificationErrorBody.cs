...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChatConversationNotificationErrorBody :  IEquatable<ChatConversationNotificationErrorBody>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatConversationNotificationErrorBody" /> class.
        /// </summary>
        ...
        public ChatConversationNotificationErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<ChatConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChatConversationNotificationErrorBody);
        }

        /// <summary>
        /// Returns true if ChatConversationNotificationErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of ChatConversationNotificationErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatConversationNotificationErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
