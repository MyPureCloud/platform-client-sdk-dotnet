...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttemptLimitsNotification);
        }

        /// <summary>
        /// Returns true if AttemptLimitsNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of AttemptLimitsNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttemptLimitsNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
