...
this.DateExpires = DateExpires;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FaxDataV2NotificationLockInfo);
        }

        /// <summary>
        /// Returns true if FaxDataV2NotificationLockInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of FaxDataV2NotificationLockInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxDataV2NotificationLockInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
