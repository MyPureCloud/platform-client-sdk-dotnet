...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CampaignNotificationUriReference :  IEquatable<CampaignNotificationUriReference>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CampaignNotificationUriReference);
        }

        /// <summary>
        /// Returns true if CampaignNotificationUriReference instances are equal
        /// </summary>
        /// <param name="other">Instance of CampaignNotificationUriReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignNotificationUriReference other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
