...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VideoConversationNotificationParticipants :  IEquatable<VideoConversationNotificationParticipants>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VideoConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if VideoConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of VideoConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
