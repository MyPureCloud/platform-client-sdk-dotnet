...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeEvaluateTradesBuJobResponse :  IEquatable<ShiftTradeEvaluateTradesBuJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeEvaluateTradesBuJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeEvaluateTradesBuJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeEvaluateTradesBuJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="EvaluateTradesResult">Results for EvaluateTrades job type.</param>
        public ShiftTradeEvaluateTradesBuJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, EvaluateShiftTradeListJobResponseItem EvaluateTradesResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
        ...
        /// </summary>
        /// <value>Results for EvaluateTrades job type</value>
        [DataMember(Name="evaluateTradesResult", EmitDefaultValue=false)]
        public EvaluateShiftTradeListJobResponseItem EvaluateTradesResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EvaluateTradesResult: ").Append(EvaluateTradesResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeEvaluateTradesBuJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeEvaluateTradesBuJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeEvaluateTradesBuJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeEvaluateTradesBuJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.EvaluateTradesResult == other.EvaluateTradesResult ||
                    this.EvaluateTradesResult != null &&
                    this.EvaluateTradesResult.Equals(other.EvaluateTradesResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EvaluateTradesResult != null)
                    hash = hash * 59 + this.EvaluateTradesResult.GetHashCode();
