...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeMatchTradeJobResponse :  IEquatable<ShiftTradeMatchTradeJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeMatchTradeJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeMatchTradeJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeMatchTradeJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="MatchTradeResult">Results for MatchTrade job type.</param>
        public ShiftTradeMatchTradeJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, EvaluatedShiftTradeResponseItem MatchTradeResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
        ...
        /// </summary>
        /// <value>Results for MatchTrade job type</value>
        [DataMember(Name="matchTradeResult", EmitDefaultValue=false)]
        public EvaluatedShiftTradeResponseItem MatchTradeResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MatchTradeResult: ").Append(MatchTradeResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeMatchTradeJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeMatchTradeJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeMatchTradeJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeMatchTradeJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.MatchTradeResult == other.MatchTradeResult ||
                    this.MatchTradeResult != null &&
                    this.MatchTradeResult.Equals(other.MatchTradeResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MatchTradeResult != null)
                    hash = hash * 59 + this.MatchTradeResult.GetHashCode();
