...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ContactListFilterNotificationFilterClause :  IEquatable<ContactListFilterNotificationFilterClause>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContactListFilterNotificationFilterClause);
        }

        /// <summary>
        /// Returns true if ContactListFilterNotificationFilterClause instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactListFilterNotificationFilterClause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactListFilterNotificationFilterClause other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
