...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2ConversationMessageTypingEventForUserTopicConversationContentGeneric :  IEquatable<V2ConversationMessageTypingEventForUserTopicConversationContentGeneric>
    {
        ...
        public List<V2ConversationMessageTypingEventForUserTopicConversationButtonComponent> Components { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ConversationMessageTypingEventForUserTopicConversationContentGeneric);
        }

        /// <summary>
        /// Returns true if V2ConversationMessageTypingEventForUserTopicConversationContentGeneric instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ConversationMessageTypingEventForUserTopicConversationContentGeneric to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ConversationMessageTypingEventForUserTopicConversationContentGeneric other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
