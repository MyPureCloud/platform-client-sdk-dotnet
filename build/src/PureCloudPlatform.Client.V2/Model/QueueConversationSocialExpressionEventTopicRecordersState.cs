...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationSocialExpressionEventTopicRecordersState :  IEquatable<QueueConversationSocialExpressionEventTopicRecordersState>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicRecordersState" /> class.
        /// </summary>
        ...
        public QueueConversationSocialExpressionEventTopicRecordersState(string AdhocState = null, string CustomerExperienceState = null, string AgentExperienceState = null, string SnippetState = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicRecordersState);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicRecordersState instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicRecordersState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicRecordersState other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
