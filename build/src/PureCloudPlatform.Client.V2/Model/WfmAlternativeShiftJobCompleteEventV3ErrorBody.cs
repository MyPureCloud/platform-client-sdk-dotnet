...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmAlternativeShiftJobCompleteEventV3ErrorBody :  IEquatable<WfmAlternativeShiftJobCompleteEventV3ErrorBody>
    {
        ...
        public WfmAlternativeShiftJobCompleteEventV3ErrorBody(int? Status = null, string Code = null, string Message = null, Dictionary<string, string> MessageParams = null)
        {
            this.Status = Status;
            this.Code = Code;
