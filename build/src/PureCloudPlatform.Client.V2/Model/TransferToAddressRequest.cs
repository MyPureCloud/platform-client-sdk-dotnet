...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class TransferToAddressRequest : IEquatable<TransferToAddressRequest>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TransferToAddressRequest" /> class.
		/// </summary>
		...
		/// <param name="Address">User&#39;s name, queue&#39;s name, destination&#39;s address or phone number..</param>
		public TransferToAddressRequest(TransferTypeEnum? TransferType = null, bool? KeepInternalMessageAlive = null, string Address = null)
		{
		...
		/// </summary>
		/// <value>User&#39;s name, queue&#39;s name, destination&#39;s address or phone number.</value>
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as TransferToAddressRequest);
		}

		/// <summary>
		/// Returns true if TransferToAddressRequest instances are equal
		/// </summary>
		/// <param name="other">Instance of TransferToAddressRequest to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(TransferToAddressRequest other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
