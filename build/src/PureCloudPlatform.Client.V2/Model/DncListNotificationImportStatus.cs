...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class DncListNotificationImportStatus :  IEquatable<DncListNotificationImportStatus>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DncListNotificationImportStatus);
        }

        /// <summary>
        /// Returns true if DncListNotificationImportStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of DncListNotificationImportStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DncListNotificationImportStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
