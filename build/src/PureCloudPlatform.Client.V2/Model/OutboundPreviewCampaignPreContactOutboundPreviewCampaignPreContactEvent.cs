...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent : IEquatable<OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent" /> class.
		/// </summary>
		...
		public OutboundPreviewCampaignPreContactVoiceAttributes VoiceAttributes { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent);
		}

		/// <summary>
		/// Returns true if OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent instances are equal
		/// </summary>
		/// <param name="other">Instance of OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(OutboundPreviewCampaignPreContactOutboundPreviewCampaignPreContactEvent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
