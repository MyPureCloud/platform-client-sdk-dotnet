...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttemptLimitsNotificationRecallEntries :  IEquatable<AttemptLimitsNotificationRecallEntries>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttemptLimitsNotificationRecallEntries);
        }

        /// <summary>
        /// Returns true if AttemptLimitsNotificationRecallEntries instances are equal
        /// </summary>
        /// <param name="other">Instance of AttemptLimitsNotificationRecallEntries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttemptLimitsNotificationRecallEntries other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
