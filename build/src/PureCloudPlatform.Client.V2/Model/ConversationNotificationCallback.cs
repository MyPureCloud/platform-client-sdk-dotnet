...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationCallback :  IEquatable<ConversationNotificationCallback>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationNotificationCallback" /> class.
        /// </summary>
...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationCallback);
        }

        /// <summary>
        /// Returns true if ConversationNotificationCallback instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationCallback other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
