...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationMessages1 :  IEquatable<ConversationNotificationMessages1>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationNotificationMessages1" /> class.
        /// </summary>
...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationMessages1);
        }

        /// <summary>
        /// Returns true if ConversationNotificationMessages1 instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationMessages1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationMessages1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
