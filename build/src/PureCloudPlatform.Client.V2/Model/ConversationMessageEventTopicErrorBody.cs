...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationMessageEventTopicErrorBody :  IEquatable<ConversationMessageEventTopicErrorBody>
    {
        ...
        public ConversationMessageEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationMessageEventTopicDetail> Details = null, List<ConversationMessageEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
