...
this.AudioTTS = AudioTTS;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GreetingNotification);
        }

        /// <summary>
        /// Returns true if GreetingNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of GreetingNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GreetingNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
