...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class Daily :  IEquatable<Daily>
    {
        ...
        /// </summary>
        /// <param name="DownloadUrl">Download URL to fetch the result of daily time series. This field is populated only if session state is Complete. The downloaded data contains Newline Delimited JSON (NDJSON): one JSON object per line.</param>
        ...
        public Daily(string DownloadUrl = null, List<ContinuousForecastTimeSeries> DownloadResult = null)
        {
        ...
        /// </summary>
        /// <value>Download URL to fetch the result of daily time series. This field is populated only if session state is Complete. The downloaded data contains Newline Delimited JSON (NDJSON): one JSON object per line</value>
