...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class SequenceSchedule :  IEquatable<SequenceSchedule>
    {
        ...
        public SequenceSchedule(string Name = null, int? Version = null, List<ScheduleInterval> Intervals = null, string TimeZone = null, UriReference Sequence = null)
        {
            ...
            if (Intervals == null)
            {
                throw new InvalidDataException("Intervals is a required property for SequenceSchedule and cannot be null");
            }
            else
            {
            ...
            if (TimeZone == null)
            {
                throw new InvalidDataException("TimeZone is a required property for SequenceSchedule and cannot be null");
            }
            else
            {
            ...
            if (Sequence == null)
            {
                throw new InvalidDataException("Sequence is a required property for SequenceSchedule and cannot be null");
            }
            else
            {
