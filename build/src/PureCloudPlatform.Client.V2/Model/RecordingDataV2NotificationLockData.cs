...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingDataV2NotificationLockData :  IEquatable<RecordingDataV2NotificationLockData>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingDataV2NotificationLockData);
        }

        /// <summary>
        /// Returns true if RecordingDataV2NotificationLockData instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingDataV2NotificationLockData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingDataV2NotificationLockData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
