...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackConversationNotificationErrorBody :  IEquatable<CallbackConversationNotificationErrorBody>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackConversationNotificationErrorBody" /> class.
        /// </summary>
        ...
        public CallbackConversationNotificationErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<CallbackConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallbackConversationNotificationErrorBody);
        }

        /// <summary>
        /// Returns true if CallbackConversationNotificationErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackConversationNotificationErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackConversationNotificationErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
