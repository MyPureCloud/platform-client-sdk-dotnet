...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeAddTradeJobResponse :  IEquatable<ShiftTradeAddTradeJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeAddTradeJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeAddTradeJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeAddTradeJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="AddTradeResult">Results for AddTrade job type.</param>
        public ShiftTradeAddTradeJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, ShiftTradeResponseItem AddTradeResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
        ...
        /// </summary>
        /// <value>Results for AddTrade job type</value>
        [DataMember(Name="addTradeResult", EmitDefaultValue=false)]
        public ShiftTradeResponseItem AddTradeResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddTradeResult: ").Append(AddTradeResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeAddTradeJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeAddTradeJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeAddTradeJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeAddTradeJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.AddTradeResult == other.AddTradeResult ||
                    this.AddTradeResult != null &&
                    this.AddTradeResult.Equals(other.AddTradeResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AddTradeResult != null)
                    hash = hash * 59 + this.AddTradeResult.GetHashCode();
