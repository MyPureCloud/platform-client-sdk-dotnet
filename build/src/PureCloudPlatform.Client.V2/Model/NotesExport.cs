...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotesExport :  IEquatable<NotesExport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotesExport" /> class.
        /// </summary>
        ...
        public NotesExport(List<string> DivisionIds = null, NotesExportQueryConditions QueryConditions = null)
        {
        ...
        public NotesExportQueryConditions QueryConditions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NotesExport);
        }

        /// <summary>
        /// Returns true if NotesExport instances are equal
        /// </summary>
        /// <param name="other">Instance of NotesExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotesExport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
