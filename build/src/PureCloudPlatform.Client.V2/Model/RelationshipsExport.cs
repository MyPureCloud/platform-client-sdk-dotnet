...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelationshipsExport :  IEquatable<RelationshipsExport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipsExport" /> class.
        /// </summary>
        ...
        public RelationshipsExport(List<string> DivisionIds = null, RelationshipsExportQueryConditions QueryConditions = null)
        {
        ...
        public RelationshipsExportQueryConditions QueryConditions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RelationshipsExport);
        }

        /// <summary>
        /// Returns true if RelationshipsExport instances are equal
        /// </summary>
        /// <param name="other">Instance of RelationshipsExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipsExport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
