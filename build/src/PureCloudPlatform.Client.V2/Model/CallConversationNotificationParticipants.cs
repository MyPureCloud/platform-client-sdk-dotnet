...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallConversationNotificationParticipants :  IEquatable<CallConversationNotificationParticipants>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallConversationNotificationParticipants" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if CallConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of CallConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
