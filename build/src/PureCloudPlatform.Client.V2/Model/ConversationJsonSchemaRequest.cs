...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationJsonSchemaRequest :  IEquatable<ConversationJsonSchemaRequest>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationJsonSchemaRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConversationJsonSchemaRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationJsonSchemaRequest" /> class.
        /// </summary>
        /// <param name="Schema">The JSON Schema specification link. The only value currently supported is \&quot;http://json-schema.org/draft-04/schema#\&quot;. (required).</param>
        /// <param name="Title">The title of the schema. Must be unique across all enabled Custom Attributes schemas. (required).</param>
        ...
        /// <param name="Properties">The map of schema properties and their limits. (required).</param>
        public ConversationJsonSchemaRequest(string Schema = null, string Title = null, string Description = null, List<string> Required = null, Dictionary<string, Object> Properties = null)
        {
            this.Schema = Schema;
            this.Title = Title;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationJsonSchemaRequest);
        }

        /// <summary>
        /// Returns true if ConversationJsonSchemaRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationJsonSchemaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationJsonSchemaRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
