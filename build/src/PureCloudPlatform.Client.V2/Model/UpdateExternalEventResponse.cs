...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateExternalEventResponse :  IEquatable<UpdateExternalEventResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExternalEventResponse" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateExternalEventResponse);
        }

        /// <summary>
        /// Returns true if UpdateExternalEventResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateExternalEventResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExternalEventResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
