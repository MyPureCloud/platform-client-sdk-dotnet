...
{
    /// <summary>
    /// ConversationIntentSuggestionsTopicQueryReformulationContext
    /// </summary>
    [DataContract]
    public partial class ConversationIntentSuggestionsTopicQueryReformulationContext :  IEquatable<ConversationIntentSuggestionsTopicQueryReformulationContext>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationIntentSuggestionsTopicQueryReformulationContext" /> class.
        /// </summary>
        /// <param name="KnowledgeClassification">KnowledgeClassification.</param>
        /// <param name="ReformulatedQuery">ReformulatedQuery.</param>
        public ConversationIntentSuggestionsTopicQueryReformulationContext(KnowledgeClassificationEnum? KnowledgeClassification = null, string ReformulatedQuery = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationIntentSuggestionsTopicQueryReformulationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationIntentSuggestionsTopicQueryReformulationContext);
        }

        /// <summary>
        /// Returns true if ConversationIntentSuggestionsTopicQueryReformulationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationIntentSuggestionsTopicQueryReformulationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationIntentSuggestionsTopicQueryReformulationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
