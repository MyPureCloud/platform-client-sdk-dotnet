...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent : IEquatable<ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent>
	{
		/// <summary>
		/// Gets or Sets State
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent" /> class.
		/// </summary>
		...
		/// <param name="KnowledgeSearch">KnowledgeSearch.</param>
		/// <param name="ActiveIntent">ActiveIntent.</param>
		public ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent(DateTime? EventTime = null, Guid? ConversationId = null, Guid? SuggestionId = null, StateEnum? State = null, TriggerTypeEnum? TriggerType = null, EngagementTypeEnum? EngagementType = null, ConversationKnowledgeSearchSuggestionsTopicSuggestionContext Context = null, ConversationKnowledgeSearchSuggestionsTopicSuggestionFeedback Feedback = null, ConversationKnowledgeSearchSuggestionsTopicSuggestedSearchResult KnowledgeSearch = null, ConversationKnowledgeSearchSuggestionsTopicSuggestedIntent ActiveIntent = null)
		{
		...
		public ConversationKnowledgeSearchSuggestionsTopicSuggestionContext Context { get; set; }
		...
		public ConversationKnowledgeSearchSuggestionsTopicSuggestionFeedback Feedback { get; set; }



		/// <summary>
		/// Gets or Sets KnowledgeSearch
		/// </summary>
		[DataMember(Name = "knowledgeSearch", EmitDefaultValue = false)]
		public ConversationKnowledgeSearchSuggestionsTopicSuggestedSearchResult KnowledgeSearch { get; set; }
		...
		public ConversationKnowledgeSearchSuggestionsTopicSuggestedIntent ActiveIntent { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent);
		}

		/// <summary>
		/// Returns true if ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationKnowledgeSearchSuggestionsTopicKnowledgeSearchSuggestionEvent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
