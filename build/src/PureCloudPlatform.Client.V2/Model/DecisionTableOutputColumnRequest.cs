...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DecisionTableOutputColumnRequest :  IEquatable<DecisionTableOutputColumnRequest>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="DecisionTableOutputColumnRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecisionTableOutputColumnRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecisionTableOutputColumnRequest" /> class.
        /// </summary>
        ...
        public DecisionTableOutputColumnRequest(DecisionTableColumnDefaultRowValue DefaultsTo = null, OutputValue Value = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DecisionTableOutputColumnRequest);
        }

        /// <summary>
        /// Returns true if DecisionTableOutputColumnRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of DecisionTableOutputColumnRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecisionTableOutputColumnRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
