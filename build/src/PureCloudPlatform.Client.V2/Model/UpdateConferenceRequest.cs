...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateConferenceRequest :  IEquatable<UpdateConferenceRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConferenceRequest" /> class.
        /// </summary>
        /// <param name="ConversationIds">A list of conversations to merge into this conversation to create a conference..</param>
        public UpdateConferenceRequest(List<string> ConversationIds = null)
        {
        ...
        /// </summary>
        /// <value>A list of conversations to merge into this conversation to create a conference.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateConferenceRequest);
        }

        /// <summary>
        /// Returns true if UpdateConferenceRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateConferenceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConferenceRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
