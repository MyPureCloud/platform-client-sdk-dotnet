...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent : IEquatable<ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent>
	{
		/// <summary>
		/// Gets or Sets State
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent" /> class.
		/// </summary>
		...
		/// <param name="ThirdPartySuggestion">ThirdPartySuggestion.</param>
		public ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent(DateTime? EventTime = null, Guid? ConversationId = null, Guid? SuggestionId = null, StateEnum? State = null, TriggerTypeEnum? TriggerType = null, EngagementTypeEnum? EngagementType = null, ConversationThirdPartyActionSuggestionsTopicSuggestionFeedback Feedback = null, ConversationThirdPartyActionSuggestionsTopicSuggestedIntent ActiveIntent = null, ConversationThirdPartyActionSuggestionsTopicSuggestionContext Context = null, ConversationThirdPartyActionSuggestionsTopicThirdPartySuggestion ThirdPartySuggestion = null)
		{
		...
		public ConversationThirdPartyActionSuggestionsTopicSuggestionFeedback Feedback { get; set; }
		...
		public ConversationThirdPartyActionSuggestionsTopicSuggestedIntent ActiveIntent { get; set; }
		...
		public ConversationThirdPartyActionSuggestionsTopicSuggestionContext Context { get; set; }



		/// <summary>
		/// Gets or Sets ThirdPartySuggestion
		/// </summary>
		[DataMember(Name = "thirdPartySuggestion", EmitDefaultValue = false)]
		public ConversationThirdPartyActionSuggestionsTopicThirdPartySuggestion ThirdPartySuggestion { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent);
		}

		/// <summary>
		/// Returns true if ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationThirdPartyActionSuggestionsTopicThirdPartyActionSuggestionEvent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
