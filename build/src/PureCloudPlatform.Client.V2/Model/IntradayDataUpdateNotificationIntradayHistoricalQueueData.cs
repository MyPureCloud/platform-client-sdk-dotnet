...
this.AverageSpeedOfAnswerSeconds = AverageSpeedOfAnswerSeconds;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationIntradayHistoricalQueueData);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationIntradayHistoricalQueueData instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationIntradayHistoricalQueueData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationIntradayHistoricalQueueData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
