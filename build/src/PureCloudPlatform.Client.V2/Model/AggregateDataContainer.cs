...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AggregateDataContainer :  IEquatable<AggregateDataContainer>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AggregateDataContainer);
        }

        /// <summary>
        /// Returns true if AggregateDataContainer instances are equal
        /// </summary>
        /// <param name="other">Instance of AggregateDataContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregateDataContainer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
