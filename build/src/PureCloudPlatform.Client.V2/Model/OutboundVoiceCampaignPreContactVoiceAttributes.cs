...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class OutboundVoiceCampaignPreContactVoiceAttributes : IEquatable<OutboundVoiceCampaignPreContactVoiceAttributes>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OutboundVoiceCampaignPreContactVoiceAttributes" /> class.
		/// </summary>
		...
		public OutboundVoiceCampaignPreContactVoiceAttributes(string ContactPhoneNumber = null, ContactPhoneTypeEnum? ContactPhoneType = null, string CallerIdPhoneNumber = null, string CallerIdName = null, string AgentOwnedColumnName = null, string PreviewModeColumnName = null, bool? IsDeliveredAsPreview = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as OutboundVoiceCampaignPreContactVoiceAttributes);
		}

		/// <summary>
		/// Returns true if OutboundVoiceCampaignPreContactVoiceAttributes instances are equal
		/// </summary>
		/// <param name="other">Instance of OutboundVoiceCampaignPreContactVoiceAttributes to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(OutboundVoiceCampaignPreContactVoiceAttributes other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
