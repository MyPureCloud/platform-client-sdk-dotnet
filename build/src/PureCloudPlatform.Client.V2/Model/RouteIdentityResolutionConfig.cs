...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RouteIdentityResolutionConfig :  IEquatable<RouteIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="RouteIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RouteIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public RouteIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RouteIdentityResolutionConfig {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RouteIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if RouteIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of RouteIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RouteIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
