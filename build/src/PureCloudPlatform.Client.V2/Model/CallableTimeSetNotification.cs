...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CallableTimeSetNotification :  IEquatable<CallableTimeSetNotification>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallableTimeSetNotification);
        }

        /// <summary>
        /// Returns true if CallableTimeSetNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of CallableTimeSetNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallableTimeSetNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
