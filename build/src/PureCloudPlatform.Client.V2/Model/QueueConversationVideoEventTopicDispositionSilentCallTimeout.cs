...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicDispositionSilentCallTimeout :  IEquatable<QueueConversationVideoEventTopicDispositionSilentCallTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicDispositionSilentCallTimeout" /> class.
        /// </summary>
        ...
        public QueueConversationVideoEventTopicDispositionSilentCallTimeout(long? TimeoutMs = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationVideoEventTopicDispositionSilentCallTimeout {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicDispositionSilentCallTimeout);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicDispositionSilentCallTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicDispositionSilentCallTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicDispositionSilentCallTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
