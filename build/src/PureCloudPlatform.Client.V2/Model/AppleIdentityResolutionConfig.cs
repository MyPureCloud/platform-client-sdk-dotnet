...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppleIdentityResolutionConfig :  IEquatable<AppleIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="AppleIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppleIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public AppleIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppleIdentityResolutionConfig {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AppleIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if AppleIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of AppleIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
