...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class BulkResponseResultVoidEntity :  IEquatable<BulkResponseResultVoidEntity>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkResponseResultVoidEntity);
        }

        /// <summary>
        /// Returns true if BulkResponseResultVoidEntity instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkResponseResultVoidEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkResponseResultVoidEntity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
