...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CoachingAnnotation :  IEquatable<CoachingAnnotation>
    {
        ...
        /// </summary>
        /// <value>The date/time the annotation was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
        ...
        /// </summary>
        /// <value>The date/time the annotation was last modified. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
