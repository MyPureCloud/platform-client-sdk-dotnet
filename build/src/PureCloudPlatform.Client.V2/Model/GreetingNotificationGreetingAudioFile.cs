...
this.SizeBytes = SizeBytes;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GreetingNotificationGreetingAudioFile);
        }

        /// <summary>
        /// Returns true if GreetingNotificationGreetingAudioFile instances are equal
        /// </summary>
        /// <param name="other">Instance of GreetingNotificationGreetingAudioFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GreetingNotificationGreetingAudioFile other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
