...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationCobrowseEventTopicWrapup :  IEquatable<QueueConversationCobrowseEventTopicWrapup>
    {
        ...
        public QueueConversationCobrowseEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, int? DurationSeconds = null, DateTime? EndTime = null, Dictionary<string, Object> AdditionalProperties = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
