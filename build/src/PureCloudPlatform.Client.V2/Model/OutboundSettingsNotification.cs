...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutboundSettingsNotification :  IEquatable<OutboundSettingsNotification>
    {
...
this.ComplianceAbandonRateDenominator = ComplianceAbandonRateDenominator;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OutboundSettingsNotification);
        }

        /// <summary>
        /// Returns true if OutboundSettingsNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundSettingsNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundSettingsNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
