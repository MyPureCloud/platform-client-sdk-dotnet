...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppleIntegrationUpdateRequest :  IEquatable<AppleIntegrationUpdateRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleIntegrationUpdateRequest" /> class.
        /// </summary>
        /// <param name="Name">The name of the Apple messaging integration..</param>
        ...
        public AppleIntegrationUpdateRequest(string Name = null, SupportedContentReference SupportedContent = null, MessagingSettingRequestReference MessagingSetting = null, string BusinessName = null, string LogoUrl = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AppleIntegrationUpdateRequest);
        }

        /// <summary>
        /// Returns true if AppleIntegrationUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AppleIntegrationUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleIntegrationUpdateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
