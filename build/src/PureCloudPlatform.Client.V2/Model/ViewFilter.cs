...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	public partial class ViewFilter : IEquatable<ViewFilter>
	{
		...
		public List<EngagementSourceEnum> EngagementSource { get; set; }
		...
		public bool Equals(ViewFilter other)
		{
			...
			return true &&
				...
				(
					...
					this.EngagementSource.SequenceEqual(other.EngagementSource)
				);
		}
