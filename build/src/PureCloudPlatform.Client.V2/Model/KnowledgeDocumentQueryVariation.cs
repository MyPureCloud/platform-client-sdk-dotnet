...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KnowledgeDocumentQueryVariation :  IEquatable<KnowledgeDocumentQueryVariation>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentQueryVariation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KnowledgeDocumentQueryVariation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentQueryVariation" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The chunk blocks associated with the variation.</value>
        [DataMember(Name="chunks", EmitDefaultValue=false)]
        public List<DocumentVariationQueryChunkBlock> Chunks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KnowledgeDocumentQueryVariation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KnowledgeDocumentQueryVariation);
        }

        /// <summary>
        /// Returns true if KnowledgeDocumentQueryVariation instances are equal
        /// </summary>
        /// <param name="other">Instance of KnowledgeDocumentQueryVariation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnowledgeDocumentQueryVariation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
