...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CampaignNotification :  IEquatable<CampaignNotification>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CampaignNotification);
        }

        /// <summary>
        /// Returns true if CampaignNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of CampaignNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
