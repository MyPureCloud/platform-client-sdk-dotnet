...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenAiPhrasesTopicsDefinitionsJob :  IEquatable<GenAiPhrasesTopicsDefinitionsJob>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenAiPhrasesTopicsDefinitionsJob" /> class.
        /// </summary>
        ...
        public GenAiPhrasesTopicsDefinitionsJob(string Id = null, StateEnum? State = null, List<GenAiPhrasesTestTopicPhraseResults> TestTopicPhraseResults = null, List<string> GenAIPhrasesResults = null)
        {
            this.Id = Id;
            this.State = State;
        ...
        public List<GenAiPhrasesTestTopicPhraseResults> TestTopicPhraseResults { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenAiPhrasesTopicsDefinitionsJob {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GenAiPhrasesTopicsDefinitionsJob);
        }

        /// <summary>
        /// Returns true if GenAiPhrasesTopicsDefinitionsJob instances are equal
        /// </summary>
        /// <param name="other">Instance of GenAiPhrasesTopicsDefinitionsJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenAiPhrasesTopicsDefinitionsJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
