...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationSocialExpressionEventTopicErrorDetails :  IEquatable<QueueConversationSocialExpressionEventTopicErrorDetails>
    {
        ...
        public QueueConversationSocialExpressionEventTopicErrorDetails(int? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, string Uri = null, Dictionary<string, Object> AdditionalProperties = null)
        {
            this.Status = Status;
            this.Code = Code;
