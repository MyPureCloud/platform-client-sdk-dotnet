...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneyWebEventsNotificationDevice :  IEquatable<JourneyWebEventsNotificationDevice>
    {
        ...
        public JourneyWebEventsNotificationDevice(string Type = null, bool? IsMobile = null, int? ScreenHeight = null, int? ScreenWidth = null, int? ScreenDensity = null, string Fingerprint = null, string OsFamily = null, string OsVersion = null, CategoryEnum? Category = null, string Manufacturer = null)
        {
            this.Type = Type;
