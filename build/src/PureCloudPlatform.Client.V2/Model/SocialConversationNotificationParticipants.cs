...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class SocialConversationNotificationParticipants :  IEquatable<SocialConversationNotificationParticipants>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocialConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if SocialConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of SocialConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
