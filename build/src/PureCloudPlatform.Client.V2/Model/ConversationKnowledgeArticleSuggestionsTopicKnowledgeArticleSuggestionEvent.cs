...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent : IEquatable<ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent>
	{
		/// <summary>
		/// Gets or Sets State
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent" /> class.
		/// </summary>
		...
		/// <param name="KnowledgeArticle">KnowledgeArticle.</param>
		/// <param name="ActiveIntent">ActiveIntent.</param>
		public ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent(DateTime? EventTime = null, Guid? ConversationId = null, Guid? SuggestionId = null, StateEnum? State = null, TriggerTypeEnum? TriggerType = null, EngagementTypeEnum? EngagementType = null, ConversationKnowledgeArticleSuggestionsTopicSuggestionContext Context = null, ConversationKnowledgeArticleSuggestionsTopicSuggestionFeedback Feedback = null, ConversationKnowledgeArticleSuggestionsTopicSuggestedArticle KnowledgeArticle = null, ConversationKnowledgeArticleSuggestionsTopicSuggestedIntent ActiveIntent = null)
		{
		...
		public ConversationKnowledgeArticleSuggestionsTopicSuggestionContext Context { get; set; }
		...
		public ConversationKnowledgeArticleSuggestionsTopicSuggestionFeedback Feedback { get; set; }



		/// <summary>
		/// Gets or Sets KnowledgeArticle
		/// </summary>
		[DataMember(Name = "knowledgeArticle", EmitDefaultValue = false)]
		public ConversationKnowledgeArticleSuggestionsTopicSuggestedArticle KnowledgeArticle { get; set; }
		...
		public ConversationKnowledgeArticleSuggestionsTopicSuggestedIntent ActiveIntent { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent);
		}

		/// <summary>
		/// Returns true if ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationKnowledgeArticleSuggestionsTopicKnowledgeArticleSuggestionEvent other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
