...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdgeMetricsTopicLocalDate :  IEquatable<EdgeMetricsTopicLocalDate>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeMetricsTopicLocalDate" /> class.
        /// </summary>
        /// <param name="Year">Year.</param>
        /// <param name="Month">Month.</param>
        /// <param name="Day">Day.</param>
        /// <param name="LeapYear">LeapYear.</param>
        public EdgeMetricsTopicLocalDate(int? Year = null, int? Month = null, int? Day = null, bool? LeapYear = null)
        {
            this.Year = Year;
            this.Month = Month;
            this.Day = Day;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EdgeMetricsTopicLocalDate);
        }

        /// <summary>
        /// Returns true if EdgeMetricsTopicLocalDate instances are equal
        /// </summary>
        /// <param name="other">Instance of EdgeMetricsTopicLocalDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeMetricsTopicLocalDate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
