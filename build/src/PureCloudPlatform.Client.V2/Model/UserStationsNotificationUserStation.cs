...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserStationsNotificationUserStation :  IEquatable<UserStationsNotificationUserStation>
    {
...
this.AssociatedUser = AssociatedUser;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserStationsNotificationUserStation);
        }

        /// <summary>
        /// Returns true if UserStationsNotificationUserStation instances are equal
        /// </summary>
        /// <param name="other">Instance of UserStationsNotificationUserStation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserStationsNotificationUserStation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
