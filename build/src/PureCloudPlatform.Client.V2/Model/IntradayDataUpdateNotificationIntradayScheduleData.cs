...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntradayDataUpdateNotificationIntradayScheduleData :  IEquatable<IntradayDataUpdateNotificationIntradayScheduleData>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationIntradayScheduleData);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationIntradayScheduleData instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationIntradayScheduleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationIntradayScheduleData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
