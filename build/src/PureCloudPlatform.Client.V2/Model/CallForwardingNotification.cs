...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallForwardingNotification :  IEquatable<CallForwardingNotification>
    {
        ...
        public List<CallForwardingNotificationCalls> Calls { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallForwardingNotification);
        }

        /// <summary>
        /// Returns true if CallForwardingNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of CallForwardingNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallForwardingNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
