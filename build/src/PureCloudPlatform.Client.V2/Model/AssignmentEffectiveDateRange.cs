...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssignmentEffectiveDateRange :  IEquatable<AssignmentEffectiveDateRange>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentEffectiveDateRange" /> class.
        /// </summary>
        ...
        public AssignmentEffectiveDateRange(String StartDate = null, String EndDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AssignmentEffectiveDateRange);
        }

        /// <summary>
        /// Returns true if AssignmentEffectiveDateRange instances are equal
        /// </summary>
        /// <param name="other">Instance of AssignmentEffectiveDateRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignmentEffectiveDateRange other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
