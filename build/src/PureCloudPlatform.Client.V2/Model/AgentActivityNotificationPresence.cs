...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentActivityNotificationPresence :  IEquatable<AgentActivityNotificationPresence>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentActivityNotificationPresence);
        }

        /// <summary>
        /// Returns true if AgentActivityNotificationPresence instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentActivityNotificationPresence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentActivityNotificationPresence other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
