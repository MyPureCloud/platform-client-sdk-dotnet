...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class KnowledgeDocumentQueryResult : IEquatable<KnowledgeDocumentQueryResult>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="KnowledgeDocumentQueryResult" /> class.
		/// </summary>
		...
		public List<KnowledgeDocumentQueryVariation> Variations { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as KnowledgeDocumentQueryResult);
		}

		/// <summary>
		/// Returns true if KnowledgeDocumentQueryResult instances are equal
		/// </summary>
		/// <param name="other">Instance of KnowledgeDocumentQueryResult to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(KnowledgeDocumentQueryResult other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
