...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SelfAgentGreeting :  IEquatable<SelfAgentGreeting>
    {
        /// <summary>
        ...
        public SelfAgentGreeting(string Name = null, Prompt InboundPrompt = null, Prompt OutboundPrompt = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SelfAgentGreeting);
        }

        /// <summary>
        /// Returns true if SelfAgentGreeting instances are equal
        /// </summary>
        /// <param name="other">Instance of SelfAgentGreeting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelfAgentGreeting other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
