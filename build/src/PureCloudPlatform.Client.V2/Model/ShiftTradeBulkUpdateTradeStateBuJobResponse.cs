...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeBulkUpdateTradeStateBuJobResponse :  IEquatable<ShiftTradeBulkUpdateTradeStateBuJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeBulkUpdateTradeStateBuJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeBulkUpdateTradeStateBuJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeBulkUpdateTradeStateBuJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="BulkUpdateTradeStatesResult">Results for BulkUpdateTradeStates job type.</param>
        public ShiftTradeBulkUpdateTradeStateBuJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, BulkUpdateShiftTradeStateResult BulkUpdateTradeStatesResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
            ...
            this.Error = Error;
            this.BulkUpdateTradeStatesResult = BulkUpdateTradeStatesResult;
        ...
        /// </summary>
        /// <value>Results for BulkUpdateTradeStates job type</value>
        [DataMember(Name="bulkUpdateTradeStatesResult", EmitDefaultValue=false)]
        public BulkUpdateShiftTradeStateResult BulkUpdateTradeStatesResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShiftTradeBulkUpdateTradeStateBuJobResponse {\n");
            ...
            sb.Append("  BulkUpdateTradeStatesResult: ").Append(BulkUpdateTradeStatesResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeBulkUpdateTradeStateBuJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeBulkUpdateTradeStateBuJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeBulkUpdateTradeStateBuJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeBulkUpdateTradeStateBuJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.BulkUpdateTradeStatesResult == other.BulkUpdateTradeStatesResult ||
                    this.BulkUpdateTradeStatesResult != null &&
                    this.BulkUpdateTradeStatesResult.Equals(other.BulkUpdateTradeStatesResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BulkUpdateTradeStatesResult != null)
                    hash = hash * 59 + this.BulkUpdateTradeStatesResult.GetHashCode();
