...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class RecordingRoadsideAssistance : IEquatable<RecordingRoadsideAssistance>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="RecordingRoadsideAssistance" /> class.
		/// </summary>
		...
		public RecordingRoadsideAssistance(string Text = null, string PhoneNumber = null, bool? IsDevicePhoneNumber = null, RecordingLocation Location = null, long? MessageNumber = null)
		{
			this.Text = Text;
		...
		public RecordingLocation Location { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class RecordingRoadsideAssistance {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as RecordingRoadsideAssistance);
		}

		/// <summary>
		/// Returns true if RecordingRoadsideAssistance instances are equal
		/// </summary>
		/// <param name="other">Instance of RecordingRoadsideAssistance to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(RecordingRoadsideAssistance other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
