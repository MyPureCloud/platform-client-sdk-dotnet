...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class Row :  IEquatable<Row>
    {
        ...
        /// Initializes a new instance of the <see cref="Row" /> class.
        /// </summary>
        /// <param name="RowId">The ID of the row to update (required).</param>
        ...
        public Row(string RowId = null, Dictionary<string, DecisionTableRowParameterValue> Inputs = null, Dictionary<string, DecisionTableRowParameterValue> Outputs = null)
        {
            this.RowId = RowId;
            this.Inputs = Inputs;
        ...
        /// </summary>
        /// <value>The ID of the row to update</value>
