...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationEventTopicDispositionSilentCallTimeout :  IEquatable<QueueConversationEventTopicDispositionSilentCallTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationEventTopicDispositionSilentCallTimeout" /> class.
        /// </summary>
        ...
        public QueueConversationEventTopicDispositionSilentCallTimeout(long? TimeoutMs = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationEventTopicDispositionSilentCallTimeout);
        }

        /// <summary>
        /// Returns true if QueueConversationEventTopicDispositionSilentCallTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicDispositionSilentCallTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicDispositionSilentCallTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
