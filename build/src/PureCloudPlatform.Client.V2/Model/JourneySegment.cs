...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneySegment :  IEquatable<JourneySegment>
    {
        ...
        /// <param name="CreatedDate">Timestamp indicating when the segment was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ.</param>
        /// <param name="ModifiedDate">Timestamp indicating when the the segment was last updated. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ.</param>
        public JourneySegment(string Name = null, bool? IsActive = null, string DisplayName = null, int? Version = null, string Description = null, string Color = null, bool? ShouldDisplayToAgent = null, Context Context = null, Journey Journey = null, DateTime? CreatedDate = null, DateTime? ModifiedDate = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>Timestamp indicating when the segment was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
        ...
        /// </summary>
        /// <value>Timestamp indicating when the the segment was last updated. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
