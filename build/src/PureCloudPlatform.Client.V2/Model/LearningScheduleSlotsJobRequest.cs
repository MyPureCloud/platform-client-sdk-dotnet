...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LearningScheduleSlotsJobRequest :  IEquatable<LearningScheduleSlotsJobRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LearningScheduleSlotsJobRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LearningScheduleSlotsJobRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LearningScheduleSlotsJobRequest" /> class.
        /// </summary>
        /// <param name="UserIds">The user IDs to fetch the slots for. (required).</param>
        ...
        public LearningScheduleSlotsJobRequest(List<string> UserIds = null, int? LengthInMinutes = null, string ActivityCodeId = null, List<string> Intervals = null, SlotsTypeEnum? SlotsType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LearningScheduleSlotsJobRequest);
        }

        /// <summary>
        /// Returns true if LearningScheduleSlotsJobRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of LearningScheduleSlotsJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LearningScheduleSlotsJobRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
