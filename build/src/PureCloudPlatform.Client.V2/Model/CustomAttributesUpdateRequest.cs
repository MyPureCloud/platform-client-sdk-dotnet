...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomAttributesUpdateRequest :  IEquatable<CustomAttributesUpdateRequest>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAttributesUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomAttributesUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAttributesUpdateRequest" /> class.
        /// </summary>
        ...
        /// <param name="SchemaId">The id of the schema that dictates which attributes can be included. Required for create, cannot be updated..</param>
        /// <param name="Version">The latest version of the Custom Attributes record. Optional for concurrency check on update..</param>
        /// <param name="CustomAttributes">The map of attribute values. (required).</param>
        public CustomAttributesUpdateRequest(string Id = null, List<string> Divisions = null, string SchemaId = null, int? Version = null, Dictionary<string, Object> CustomAttributes = null)
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>The id of the schema that dictates which attributes can be included. Required for create, cannot be updated.</value>
        ...
        /// </summary>
        /// <value>The latest version of the Custom Attributes record. Optional for concurrency check on update.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomAttributesUpdateRequest);
        }

        /// <summary>
        /// Returns true if CustomAttributesUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomAttributesUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomAttributesUpdateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
