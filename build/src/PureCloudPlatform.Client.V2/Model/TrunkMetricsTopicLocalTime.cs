...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrunkMetricsTopicLocalTime :  IEquatable<TrunkMetricsTopicLocalTime>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrunkMetricsTopicLocalTime" /> class.
        /// </summary>
        /// <param name="Hour">Hour.</param>
        /// <param name="Minute">Minute.</param>
        /// <param name="Second">Second.</param>
        /// <param name="Nano">Nano.</param>
        public TrunkMetricsTopicLocalTime(int? Hour = null, int? Minute = null, int? Second = null, int? Nano = null)
        {
            this.Hour = Hour;
            this.Minute = Minute;
            this.Second = Second;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrunkMetricsTopicLocalTime {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrunkMetricsTopicLocalTime);
        }

        /// <summary>
        /// Returns true if TrunkMetricsTopicLocalTime instances are equal
        /// </summary>
        /// <param name="other">Instance of TrunkMetricsTopicLocalTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrunkMetricsTopicLocalTime other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
