...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext :  IEquatable<ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext" /> class.
        /// </summary>
        /// <param name="KnowledgeClassification">KnowledgeClassification.</param>
        /// <param name="ReformulatedQuery">ReformulatedQuery.</param>
        public ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext(KnowledgeClassificationEnum? KnowledgeClassification = null, string ReformulatedQuery = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext);
        }

        /// <summary>
        /// Returns true if ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationKnowledgeSearchSuggestionsTopicQueryReformulationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
