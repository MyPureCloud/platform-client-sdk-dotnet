...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationLink :  IEquatable<OrganizationLink>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationLink() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationLink" /> class.
        /// </summary>
        /// <param name="SourceOrganizationId">Organization Id for the login organization. (required).</param>
        /// <param name="TargetOrganizationId">Organization Id for the linking organization. (required).</param>
        /// <param name="SourceRegion">Region where context organization is hosted, ie. us-east-1 (required).</param>
        /// <param name="TargetRegion">Region where linking organization is hosted, ie. us-east-2 (required).</param>
        /// <param name="Status">Status of the linking..</param>
        public OrganizationLink(string SourceOrganizationId = null, string TargetOrganizationId = null, string SourceRegion = null, string TargetRegion = null, StatusEnum? Status = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrganizationLink);
        }

        /// <summary>
        /// Returns true if OrganizationLink instances are equal
        /// </summary>
        /// <param name="other">Instance of OrganizationLink to be compared</param>
        /// <returns>Boolean</returns>
