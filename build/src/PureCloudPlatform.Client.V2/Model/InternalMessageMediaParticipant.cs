...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InternalMessageMediaParticipant :  IEquatable<InternalMessageMediaParticipant>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalMessageMediaParticipant" /> class.
        /// </summary>
        ...
        /// <param name="InternalMessageId">The internal message communication ID..</param>
        /// <param name="TargetUser">The user participant on receiving side of the internal message conversation..</param>
        /// <param name="SourceUser">The user participant on sending side of the internal message conversation..</param>
        ...
        /// </summary>
        /// <value>The internal message communication ID.</value>
        [DataMember(Name="internalMessageId", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The user participant on receiving side of the internal message conversation.</value>
        ...
        /// </summary>
        /// <value>The user participant on sending side of the internal message conversation.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InternalMessageMediaParticipant);
        }

        /// <summary>
        /// Returns true if InternalMessageMediaParticipant instances are equal
        /// </summary>
        /// <param name="other">Instance of InternalMessageMediaParticipant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalMessageMediaParticipant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.InternalMessageId == other.InternalMessageId ||
                    this.InternalMessageId != null &&
                    this.InternalMessageId.Equals(other.InternalMessageId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InternalMessageId != null)
                    hash = hash * 59 + this.InternalMessageId.GetHashCode();
