...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class OutboundVoiceCampaignPostContactVoiceAttributes : IEquatable<OutboundVoiceCampaignPostContactVoiceAttributes>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OutboundVoiceCampaignPostContactVoiceAttributes" /> class.
		/// </summary>
		...
		public OutboundVoiceCampaignPostContactVoiceAttributes(string ContactPhoneNumber = null, ContactPhoneTypeEnum? ContactPhoneType = null, string CallerIdPhoneNumber = null, string CallerIdName = null, string AgentOwnedColumnName = null, string PreviewModeColumnName = null, bool? IsDeliveredAsPreview = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as OutboundVoiceCampaignPostContactVoiceAttributes);
		}

		/// <summary>
		/// Returns true if OutboundVoiceCampaignPostContactVoiceAttributes instances are equal
		/// </summary>
		/// <param name="other">Instance of OutboundVoiceCampaignPostContactVoiceAttributes to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(OutboundVoiceCampaignPostContactVoiceAttributes other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
