...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class AgentAdherenceDayMetrics : IEquatable<AgentAdherenceDayMetrics>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="AgentAdherenceDayMetrics" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected AgentAdherenceDayMetrics() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="AgentAdherenceDayMetrics" /> class.
		/// </summary>
		/// <param name="DayStartOffsetSeconds">Start of day offset in seconds relative to query start time (required).</param>
		/// <param name="AdherenceScheduleSeconds">Duration of schedule in seconds included for adherence percentage calculation (required).</param>
		...
		/// <param name="ExceptionCount">Total number of adherence exceptions for this user (required).</param>
		/// <param name="ExceptionDurationSeconds">Total duration in seconds of adherence exceptions for this user (required).</param>
		/// <param name="ImpactSeconds">The impact duration in seconds of current adherence state for this user (required).</param>
		/// <param name="ScheduleLengthSeconds">Total duration in seconds for all scheduled activities (required).</param>
		/// <param name="ActualLengthSeconds">Total duration in seconds for all actually worked activities (required).</param>
		...
		public override string ToString()
		{
			...
			sb.Append("class AgentAdherenceDayMetrics {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as AgentAdherenceDayMetrics);
		}

		/// <summary>
		/// Returns true if AgentAdherenceDayMetrics instances are equal
		/// </summary>
		/// <param name="other">Instance of AgentAdherenceDayMetrics to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(AgentAdherenceDayMetrics other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
