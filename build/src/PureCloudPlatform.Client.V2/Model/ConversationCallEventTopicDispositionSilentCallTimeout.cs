...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationCallEventTopicDispositionSilentCallTimeout : IEquatable<ConversationCallEventTopicDispositionSilentCallTimeout>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationCallEventTopicDispositionSilentCallTimeout" /> class.
		/// </summary>
		...
		public ConversationCallEventTopicDispositionSilentCallTimeout(long? TimeoutMs = null, double? TimerStartTime = null, double? TimerEndTime = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationCallEventTopicDispositionSilentCallTimeout);
		}

		/// <summary>
		/// Returns true if ConversationCallEventTopicDispositionSilentCallTimeout instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationCallEventTopicDispositionSilentCallTimeout to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationCallEventTopicDispositionSilentCallTimeout other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
