...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class SendAgentlessOutboundMessageRequest :  IEquatable<SendAgentlessOutboundMessageRequest>
    {
        ...
        /// </summary>
        /// <value>The messaging address of the sender of the message. For an SMS messenger type, this must be a currently provisioned SMS phone number. For a WhatsApp, Open and Apple messenger types use the provisioned integration’s ID. For WebMessaging use the DeploymentId</value>
