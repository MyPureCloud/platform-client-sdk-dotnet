...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingFormResponseContent :  IEquatable<RecordingFormResponseContent>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordingFormResponseContent" /> class.
        /// </summary>
        /// <param name="ContentType">Type of this content element..</param>
        /// <param name="ButtonResponse">Button response content..</param>
        public RecordingFormResponseContent(ContentTypeEnum? ContentType = null, ButtonResponse ButtonResponse = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingFormResponseContent);
        }

        /// <summary>
        /// Returns true if RecordingFormResponseContent instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingFormResponseContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingFormResponseContent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
