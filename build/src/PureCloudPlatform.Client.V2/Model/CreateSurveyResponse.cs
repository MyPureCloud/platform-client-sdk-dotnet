...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSurveyResponse :  IEquatable<CreateSurveyResponse>
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSurveyResponse" /> class.
        /// </summary>
        ...
        /// <param name="CustomerSurveyUrl">The URL for the customer survey..</param>
        public CreateSurveyResponse(string Name = null, ConversationReference Conversation = null, SurveyForm SurveyForm = null, DomainEntityRef Agent = null, StatusEnum? Status = null, QueueReference Queue = null, SurveyScoringSet Answers = null, DateTime? CompletedDate = null, SurveyErrorDetails SurveyErrorDetails = null, Team AgentTeam = null, SurveyTypeEnum? SurveyType = null, bool? MissingRequiredAnswer = null, AddressableEntityRef Flow = null, string CustomerSurveyUrl = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The URL for the customer survey.</value>
        [DataMember(Name="customerSurveyUrl", EmitDefaultValue=false)]
        public string CustomerSurveyUrl { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CustomerSurveyUrl: ").Append(CustomerSurveyUrl).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateSurveyResponse);
        }

        /// <summary>
        /// Returns true if CreateSurveyResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateSurveyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSurveyResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.CustomerSurveyUrl == other.CustomerSurveyUrl ||
                    this.CustomerSurveyUrl != null &&
                    this.CustomerSurveyUrl.Equals(other.CustomerSurveyUrl)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CustomerSurveyUrl != null)
                    hash = hash * 59 + this.CustomerSurveyUrl.GetHashCode();
