...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkEntityErrorPrefix :  IEquatable<BulkEntityErrorPrefix>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkEntityErrorPrefix" /> class.
        /// </summary>
        ...
        public BulkEntityErrorPrefix(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, Prefix Entity = null)
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkEntityErrorPrefix);
        }

        /// <summary>
        /// Returns true if BulkEntityErrorPrefix instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkEntityErrorPrefix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkEntityErrorPrefix other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
