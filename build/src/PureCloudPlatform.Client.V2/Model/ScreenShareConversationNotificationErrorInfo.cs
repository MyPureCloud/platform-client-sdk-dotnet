...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScreenShareConversationNotificationErrorInfo :  IEquatable<ScreenShareConversationNotificationErrorInfo>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenShareConversationNotificationErrorInfo" /> class.
        /// </summary>
        ...
        public ScreenShareConversationNotificationErrorInfo(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<ScreenShareConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public List<ScreenShareConversationNotificationErrorBody> Errors { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ScreenShareConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if ScreenShareConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of ScreenShareConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenShareConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
