...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class PerformancePredictionCompleteEventTopicErrorBody :  IEquatable<PerformancePredictionCompleteEventTopicErrorBody>
    {
        ...
        public PerformancePredictionCompleteEventTopicErrorBody(int? Status = null, string Code = null, string Message = null, Dictionary<string, string> MessageParams = null)
        {
            this.Status = Status;
            this.Code = Code;
