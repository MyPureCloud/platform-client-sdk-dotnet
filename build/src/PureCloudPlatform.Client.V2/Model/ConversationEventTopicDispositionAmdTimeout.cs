...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEventTopicDispositionAmdTimeout :  IEquatable<ConversationEventTopicDispositionAmdTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEventTopicDispositionAmdTimeout" /> class.
        /// </summary>
        ...
        public ConversationEventTopicDispositionAmdTimeout(long? TimeoutMs = null, string TimerStartEvent = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicDispositionAmdTimeout);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicDispositionAmdTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicDispositionAmdTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicDispositionAmdTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
