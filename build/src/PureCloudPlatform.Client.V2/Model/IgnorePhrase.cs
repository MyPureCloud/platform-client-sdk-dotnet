...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IgnorePhrase :  IEquatable<IgnorePhrase>
    {
        /// <summary>
        /// Type of participant
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IgnorePhrase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IgnorePhrase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IgnorePhrase" /> class.
        /// </summary>
        /// <param name="Text">Text of the phrase to be ignored (required).</param>
        /// <param name="Participant">Type of participant (required).</param>
        /// <param name="MediaType">Media Type for the entity (Optional).</param>
        public IgnorePhrase(string Text = null, ParticipantEnum? Participant = null, MediaTypeEnum? MediaType = null)
        {
            this.Text = Text;
        ...
        /// </summary>
        /// <value>Text of the phrase to be ignored</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IgnorePhrase);
        }

        /// <summary>
        /// Returns true if IgnorePhrase instances are equal
        /// </summary>
        /// <param name="other">Instance of IgnorePhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IgnorePhrase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
