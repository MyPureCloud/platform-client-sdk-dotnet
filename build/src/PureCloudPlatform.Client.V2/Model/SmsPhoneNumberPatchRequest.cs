...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class SmsPhoneNumberPatchRequest : IEquatable<SmsPhoneNumberPatchRequest>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SmsPhoneNumberPatchRequest" /> class.
		/// </summary>
		/// <param name="SupportedContent">Defines the media SupportedContent profile configured for an MMS capable phone number..</param>
		public SmsPhoneNumberPatchRequest(SupportedContentReference SupportedContent = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as SmsPhoneNumberPatchRequest);
		}

		/// <summary>
		/// Returns true if SmsPhoneNumberPatchRequest instances are equal
		/// </summary>
		/// <param name="other">Instance of SmsPhoneNumberPatchRequest to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(SmsPhoneNumberPatchRequest other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
