...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContactListNotificationContactPhoneNumberColumn);
        }

        /// <summary>
        /// Returns true if ContactListNotificationContactPhoneNumberColumn instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactListNotificationContactPhoneNumberColumn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactListNotificationContactPhoneNumberColumn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
