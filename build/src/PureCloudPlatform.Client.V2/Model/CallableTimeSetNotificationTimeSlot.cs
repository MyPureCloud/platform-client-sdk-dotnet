...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallableTimeSetNotificationTimeSlot :  IEquatable<CallableTimeSetNotificationTimeSlot>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallableTimeSetNotificationTimeSlot);
        }

        /// <summary>
        /// Returns true if CallableTimeSetNotificationTimeSlot instances are equal
        /// </summary>
        /// <param name="other">Instance of CallableTimeSetNotificationTimeSlot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallableTimeSetNotificationTimeSlot other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
