...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TwitterIdentityResolutionConfig :  IEquatable<TwitterIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TwitterIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TwitterIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TwitterIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public TwitterIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TwitterIdentityResolutionConfig {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TwitterIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if TwitterIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of TwitterIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwitterIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
