...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactListsBulkEditResponse :  IEquatable<ContactListsBulkEditResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactListsBulkEditResponse" /> class.
        /// </summary>
        ...
        public ContactListsBulkEditResponse(List<BulkResponseResultContactListContactListBulkEntityErrorContactList> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
        {
        ...
        public List<BulkResponseResultContactListContactListBulkEntityErrorContactList> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContactListsBulkEditResponse);
        }

        /// <summary>
        /// Returns true if ContactListsBulkEditResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactListsBulkEditResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactListsBulkEditResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
