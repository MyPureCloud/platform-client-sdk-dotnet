...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class Facet :  IEquatable<Facet>
    {
        ...
        public Facet(string Name = null, string Type = null)
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for Facet and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Facet and cannot be null");
            }
            else
            {
                this.Type = Type;
