...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowNotificationNotificationUser :  IEquatable<FlowNotificationNotificationUser>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowNotificationNotificationUser" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowNotificationNotificationUser);
        }

        /// <summary>
        /// Returns true if FlowNotificationNotificationUser instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowNotificationNotificationUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowNotificationNotificationUser other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
