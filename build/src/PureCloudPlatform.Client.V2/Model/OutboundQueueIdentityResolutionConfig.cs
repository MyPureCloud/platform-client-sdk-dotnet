...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class OutboundQueueIdentityResolutionConfig : IEquatable<OutboundQueueIdentityResolutionConfig>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="OutboundQueueIdentityResolutionConfig" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected OutboundQueueIdentityResolutionConfig() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="OutboundQueueIdentityResolutionConfig" /> class.
		/// </summary>
		...
		public OutboundQueueIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class OutboundQueueIdentityResolutionConfig {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as OutboundQueueIdentityResolutionConfig);
		}

		/// <summary>
		/// Returns true if OutboundQueueIdentityResolutionConfig instances are equal
		/// </summary>
		/// <param name="other">Instance of OutboundQueueIdentityResolutionConfig to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(OutboundQueueIdentityResolutionConfig other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
