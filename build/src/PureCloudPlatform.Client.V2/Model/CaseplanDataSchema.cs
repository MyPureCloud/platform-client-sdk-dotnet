...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CaseplanDataSchema :  IEquatable<CaseplanDataSchema>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CaseplanDataSchema);
        }

        /// <summary>
        /// Returns true if CaseplanDataSchema instances are equal
        /// </summary>
        /// <param name="other">Instance of CaseplanDataSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseplanDataSchema other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
