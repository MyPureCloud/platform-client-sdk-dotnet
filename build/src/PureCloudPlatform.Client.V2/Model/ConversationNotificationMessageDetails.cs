...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationMessageDetails :  IEquatable<ConversationNotificationMessageDetails>
    {
        ...
        public ConversationNotificationMessageDetails(string MessageId = null, DateTime? MessageTime = null)
        {
...
this.MessageTime = MessageTime;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationMessageDetails);
        }

        /// <summary>
        /// Returns true if ConversationNotificationMessageDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationMessageDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationMessageDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
