...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsIdentityResolutionConfig :  IEquatable<SmsIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="SmsIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SmsIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public SmsIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SmsIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if SmsIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of SmsIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmsIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
