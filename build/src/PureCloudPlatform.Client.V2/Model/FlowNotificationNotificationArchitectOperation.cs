...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class FlowNotificationNotificationArchitectOperation :  IEquatable<FlowNotificationNotificationArchitectOperation>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowNotificationNotificationArchitectOperation);
        }

        /// <summary>
        /// Returns true if FlowNotificationNotificationArchitectOperation instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowNotificationNotificationArchitectOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowNotificationNotificationArchitectOperation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
