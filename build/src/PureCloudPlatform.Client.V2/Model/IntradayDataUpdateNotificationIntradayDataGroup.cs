...
this.PerformancePredictionQueueDataPerInterval = PerformancePredictionQueueDataPerInterval;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationIntradayDataGroup);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationIntradayDataGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationIntradayDataGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationIntradayDataGroup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
