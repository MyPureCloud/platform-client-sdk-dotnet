...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CampaignNotificationContactSort);
        }

        /// <summary>
        /// Returns true if CampaignNotificationContactSort instances are equal
        /// </summary>
        /// <param name="other">Instance of CampaignNotificationContactSort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignNotificationContactSort other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
