...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentQueryOpportunityResult :  IEquatable<AgentQueryOpportunityResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentQueryOpportunityResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentQueryOpportunityResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentQueryOpportunityResult" /> class.
        /// </summary>
        ...
        /// <param name="Capacity">The maximum capacity for this opportunity (required).</param>
        /// <param name="EnrollmentCounts">Subset of enrollment counts which are relevant to the agent (required).</param>
        /// <param name="Enrollment">The agent&#39;s enrollment in this opportunity, if enrolled.</param>
        /// <param name="Metadata">The metadata for the opportunity (required).</param>
        public AgentQueryOpportunityResult(string Name = null, string Description = null, string ActivityCodeId = null, DateTime? StartDate = null, DateTime? EndDate = null, DateTime? DeadlineDate = null, StatusEnum? Status = null, int? Capacity = null, PendingAndApprovedOpportunityEnrollmentCounts EnrollmentCounts = null, AgentOpportunityEnrollmentResult Enrollment = null, WfmVersionedEntityMetadata Metadata = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The maximum capacity for this opportunity</value>
        ...
        /// </summary>
        /// <value>Subset of enrollment counts which are relevant to the agent</value>
        ...
        /// </summary>
        /// <value>The agent&#39;s enrollment in this opportunity, if enrolled</value>
        [DataMember(Name="enrollment", EmitDefaultValue=false)]
        public AgentOpportunityEnrollmentResult Enrollment { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentQueryOpportunityResult);
        }

        /// <summary>
        /// Returns true if AgentQueryOpportunityResult instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentQueryOpportunityResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentQueryOpportunityResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
