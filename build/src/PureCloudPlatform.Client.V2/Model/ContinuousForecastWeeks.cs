...
{
    /// <summary>
    /// ContinuousForecastWeeks
    /// </summary>
    [DataContract]
    public partial class ContinuousForecastWeeks :  IEquatable<ContinuousForecastWeeks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinuousForecastWeeks" /> class.
        /// </summary>
        ...
        public ContinuousForecastWeeks(int? WeekOffset = null, List<double?> Values = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContinuousForecastWeeks {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContinuousForecastWeeks);
        }

        /// <summary>
        /// Returns true if ContinuousForecastWeeks instances are equal
        /// </summary>
        /// <param name="other">Instance of ContinuousForecastWeeks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContinuousForecastWeeks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
