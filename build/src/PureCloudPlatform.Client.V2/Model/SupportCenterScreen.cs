...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class SupportCenterScreen :  IEquatable<SupportCenterScreen>
    {
        ...
        /// </summary>
        /// <value>The type of the screen. Required if support center is enabled</value>
        ...
        /// </summary>
        /// <param name="Type">The type of the screen. Required if support center is enabled.</param>
        /// <param name="ModuleSettings">Module settings for the screen, valid modules for each screenType: Home: Search, Categories, TopViewedArticles; Category: Search, Categories; SearchResults: Search, Results; Article: Search, Article; Required if support center is enabled.</param>
        ...
        /// </summary>
        /// <value>Module settings for the screen, valid modules for each screenType: Home: Search, Categories, TopViewedArticles; Category: Search, Categories; SearchResults: Search, Results; Article: Search, Article; Required if support center is enabled</value>
