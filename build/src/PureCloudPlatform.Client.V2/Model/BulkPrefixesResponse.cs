...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkPrefixesResponse :  IEquatable<BulkPrefixesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkPrefixesResponse" /> class.
        /// </summary>
        ...
        public BulkPrefixesResponse(List<BulkResponseResultPrefixPrefixBulkEntityErrorPrefix> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
        {
        ...
        public List<BulkResponseResultPrefixPrefixBulkEntityErrorPrefix> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkPrefixesResponse);
        }

        /// <summary>
        /// Returns true if BulkPrefixesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkPrefixesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkPrefixesResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
