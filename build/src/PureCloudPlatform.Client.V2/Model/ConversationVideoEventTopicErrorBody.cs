...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationVideoEventTopicErrorBody :  IEquatable<ConversationVideoEventTopicErrorBody>
    {
        ...
        public ConversationVideoEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationVideoEventTopicDetail> Details = null, List<ConversationVideoEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
