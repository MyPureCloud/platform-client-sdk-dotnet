...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseSetNotification :  IEquatable<ResponseSetNotification>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSetNotification" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseSetNotification);
        }

        /// <summary>
        /// Returns true if ResponseSetNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseSetNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSetNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
