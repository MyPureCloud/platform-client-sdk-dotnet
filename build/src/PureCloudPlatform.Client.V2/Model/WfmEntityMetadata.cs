...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmEntityMetadata :  IEquatable<WfmEntityMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmEntityMetadata" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmEntityMetadata);
        }

        /// <summary>
        /// Returns true if WfmEntityMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmEntityMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmEntityMetadata other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
