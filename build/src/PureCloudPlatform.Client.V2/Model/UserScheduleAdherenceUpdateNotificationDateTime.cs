...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserScheduleAdherenceUpdateNotificationDateTime :  IEquatable<UserScheduleAdherenceUpdateNotificationDateTime>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserScheduleAdherenceUpdateNotificationDateTime);
        }

        /// <summary>
        /// Returns true if UserScheduleAdherenceUpdateNotificationDateTime instances are equal
        /// </summary>
        /// <param name="other">Instance of UserScheduleAdherenceUpdateNotificationDateTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserScheduleAdherenceUpdateNotificationDateTime other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
