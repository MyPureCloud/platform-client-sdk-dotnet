...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class UserChatSettings : IEquatable<UserChatSettings>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="UserChatSettings" /> class.
		/// </summary>
		...
		public UserChatSettings(bool? Muted = null, bool? MentionsOnly = null, bool? NotifyOnReactions = null)
		{
			this.Muted = Muted;
		...
		public override string ToString()
		{
			...
			sb.Append("class UserChatSettings {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as UserChatSettings);
		}

		/// <summary>
		/// Returns true if UserChatSettings instances are equal
		/// </summary>
		/// <param name="other">Instance of UserChatSettings to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(UserChatSettings other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
