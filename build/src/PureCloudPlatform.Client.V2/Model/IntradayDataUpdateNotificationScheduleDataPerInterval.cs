...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class IntradayDataUpdateNotificationScheduleDataPerInterval :  IEquatable<IntradayDataUpdateNotificationScheduleDataPerInterval>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationScheduleDataPerInterval);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationScheduleDataPerInterval instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationScheduleDataPerInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationScheduleDataPerInterval other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
