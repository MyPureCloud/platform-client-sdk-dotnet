...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArchitectValidateJobStateResponse :  IEquatable<ArchitectValidateJobStateResponse>
    {
        /// <summary>
        /// Status of the Architect Validate Job
        /// </summary>
        /// <value>Status of the Architect Validate Job</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchitectValidateJobStateResponse" /> class.
        /// </summary>
        /// <param name="Status">Status of the Architect Validate Job.</param>
        ...
        public ArchitectValidateJobStateResponse(StatusEnum? Status = null, CommandEnum? Command = null, List<ArchitectJobMessage> Messages = null)
        {
            this.Status = Status;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ArchitectValidateJobStateResponse);
        }

        /// <summary>
        /// Returns true if ArchitectValidateJobStateResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ArchitectValidateJobStateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchitectValidateJobStateResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
