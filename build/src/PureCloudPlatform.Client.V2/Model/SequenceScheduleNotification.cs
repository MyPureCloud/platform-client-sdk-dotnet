...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SequenceScheduleNotification :  IEquatable<SequenceScheduleNotification>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SequenceScheduleNotification);
        }

        /// <summary>
        /// Returns true if SequenceScheduleNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of SequenceScheduleNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SequenceScheduleNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
