...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class QueueConversationEventTopicRecordersState : IEquatable<QueueConversationEventTopicRecordersState>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="QueueConversationEventTopicRecordersState" /> class.
		/// </summary>
		...
		public QueueConversationEventTopicRecordersState(string AdhocState = null, string CustomerExperienceState = null, string AgentExperienceState = null, string SnippetState = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as QueueConversationEventTopicRecordersState);
		}

		/// <summary>
		/// Returns true if QueueConversationEventTopicRecordersState instances are equal
		/// </summary>
		/// <param name="other">Instance of QueueConversationEventTopicRecordersState to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(QueueConversationEventTopicRecordersState other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
