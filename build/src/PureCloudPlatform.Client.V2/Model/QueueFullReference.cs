...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueFullReference :  IEquatable<QueueFullReference>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueFullReference" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueFullReference {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueFullReference);
        }

        /// <summary>
        /// Returns true if QueueFullReference instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueFullReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueFullReference other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
