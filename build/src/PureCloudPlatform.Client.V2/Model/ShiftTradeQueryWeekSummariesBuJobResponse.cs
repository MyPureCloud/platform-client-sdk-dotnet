...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeQueryWeekSummariesBuJobResponse :  IEquatable<ShiftTradeQueryWeekSummariesBuJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeQueryWeekSummariesBuJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeQueryWeekSummariesBuJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeQueryWeekSummariesBuJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="QueryWeekSummariesResult">Results for QueryWeekSummaries job type.</param>
        public ShiftTradeQueryWeekSummariesBuJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, QueryWeekSummaryListJobResponseItem QueryWeekSummariesResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
            ...
            this.Error = Error;
            this.QueryWeekSummariesResult = QueryWeekSummariesResult;
        ...
        /// <summary>
        /// Results for QueryWeekSummaries job type
        /// </summary>
        /// <value>Results for QueryWeekSummaries job type</value>
        [DataMember(Name="queryWeekSummariesResult", EmitDefaultValue=false)]
        public QueryWeekSummaryListJobResponseItem QueryWeekSummariesResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShiftTradeQueryWeekSummariesBuJobResponse {\n");
            ...
            sb.Append("  QueryWeekSummariesResult: ").Append(QueryWeekSummariesResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeQueryWeekSummariesBuJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeQueryWeekSummariesBuJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeQueryWeekSummariesBuJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeQueryWeekSummariesBuJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.QueryWeekSummariesResult == other.QueryWeekSummariesResult ||
                    this.QueryWeekSummariesResult != null &&
                    this.QueryWeekSummariesResult.Equals(other.QueryWeekSummariesResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QueryWeekSummariesResult != null)
                    hash = hash * 59 + this.QueryWeekSummariesResult.GetHashCode();
