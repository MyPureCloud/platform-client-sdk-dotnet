...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrunkInstanceSearchResponse :  IEquatable<TrunkInstanceSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TrunkInstanceSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrunkInstanceSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrunkInstanceSearchResponse" /> class.
        /// </summary>
        ...
        public TrunkInstanceSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<Trunk> Results = null)
        {
            this.Total = Total;
        ...
        public List<Trunk> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrunkInstanceSearchResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrunkInstanceSearchResponse);
        }

        /// <summary>
        /// Returns true if TrunkInstanceSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrunkInstanceSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrunkInstanceSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
