...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailCommunicationRepliedEvent :  IEquatable<EmailCommunicationRepliedEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationRepliedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailCommunicationRepliedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationRepliedEvent" /> class.
        /// </summary>
        ...
        public EmailCommunicationRepliedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailCommunicationRepliedEvent);
        }

        /// <summary>
        /// Returns true if EmailCommunicationRepliedEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailCommunicationRepliedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailCommunicationRepliedEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
