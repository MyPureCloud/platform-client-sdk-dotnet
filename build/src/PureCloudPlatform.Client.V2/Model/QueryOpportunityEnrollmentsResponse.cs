...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryOpportunityEnrollmentsResponse :  IEquatable<QueryOpportunityEnrollmentsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOpportunityEnrollmentsResponse" /> class.
        /// </summary>
        ...
        public QueryOpportunityEnrollmentsResponse(QueryOpportunityEnrollmentsResult Result = null, string DownloadUrl = null)
        {
            this.Result = Result;
        ...
        public QueryOpportunityEnrollmentsResult Result { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueryOpportunityEnrollmentsResponse);
        }

        /// <summary>
        /// Returns true if QueryOpportunityEnrollmentsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of QueryOpportunityEnrollmentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryOpportunityEnrollmentsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
