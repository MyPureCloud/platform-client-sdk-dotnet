...
{
    /// <summary>
    /// ChatConversationNotificationErrorInfo
    /// </summary>
    [DataContract]
    public partial class ChatConversationNotificationErrorInfo :  IEquatable<ChatConversationNotificationErrorInfo>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatConversationNotificationErrorInfo" /> class.
        /// </summary>
        ...
        public ChatConversationNotificationErrorInfo(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<ChatConversationNotificationErrorBody> Errors = null)
        {
...
this.Errors = Errors;
        ...
        public List<ChatConversationNotificationErrorBody> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChatConversationNotificationErrorInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChatConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if ChatConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of ChatConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
