...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentActivityNotificationOrganizationPresence :  IEquatable<AgentActivityNotificationOrganizationPresence>
    {
...
this.SystemPresence = SystemPresence;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentActivityNotificationOrganizationPresence);
        }

        /// <summary>
        /// Returns true if AgentActivityNotificationOrganizationPresence instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentActivityNotificationOrganizationPresence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentActivityNotificationOrganizationPresence other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
