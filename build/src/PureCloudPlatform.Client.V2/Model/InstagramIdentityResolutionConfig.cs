...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class InstagramIdentityResolutionConfig : IEquatable<InstagramIdentityResolutionConfig>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="InstagramIdentityResolutionConfig" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected InstagramIdentityResolutionConfig() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="InstagramIdentityResolutionConfig" /> class.
		/// </summary>
		...
		public InstagramIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as InstagramIdentityResolutionConfig);
		}

		/// <summary>
		/// Returns true if InstagramIdentityResolutionConfig instances are equal
		/// </summary>
		/// <param name="other">Instance of InstagramIdentityResolutionConfig to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(InstagramIdentityResolutionConfig other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
