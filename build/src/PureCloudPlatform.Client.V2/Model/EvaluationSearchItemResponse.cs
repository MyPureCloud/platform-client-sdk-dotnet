...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EvaluationSearchItemResponse :  IEquatable<EvaluationSearchItemResponse>
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationSearchItemResponse" /> class.
        /// </summary>
        ...
        public EvaluationFormSearchResponse EvaluationForm { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EvaluationSearchItemResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EvaluationSearchItemResponse);
        }

        /// <summary>
        /// Returns true if EvaluationSearchItemResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of EvaluationSearchItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvaluationSearchItemResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
