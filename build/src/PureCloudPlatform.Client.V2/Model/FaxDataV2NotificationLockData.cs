...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FaxDataV2NotificationLockData :  IEquatable<FaxDataV2NotificationLockData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FaxDataV2NotificationLockData" /> class.
        /// </summary>
        /// <param name="LockedBy">LockedBy.</param>
        /// <param name="DateCreated">DateCreated.</param>
        /// <param name="DateExpires">DateExpires.</param>
        public FaxDataV2NotificationLockData(FaxDataV2NotificationUserData LockedBy = null, DateTime? DateCreated = null, DateTime? DateExpires = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FaxDataV2NotificationLockData);
        }

        /// <summary>
        /// Returns true if FaxDataV2NotificationLockData instances are equal
        /// </summary>
        /// <param name="other">Instance of FaxDataV2NotificationLockData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxDataV2NotificationLockData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
