...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailCampaignScheduleConfigChangeScheduleInterval :  IEquatable<EmailCampaignScheduleConfigChangeScheduleInterval>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCampaignScheduleConfigChangeScheduleInterval" /> class.
        /// </summary>
        ...
        public EmailCampaignScheduleConfigChangeScheduleInterval(string Start = null, string End = null, Dictionary<string, Object> AdditionalProperties = null, Dictionary<string, Object> GetAdditionalProperties = null)
        {
            this.Start = Start;
            this.End = End;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailCampaignScheduleConfigChangeScheduleInterval {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailCampaignScheduleConfigChangeScheduleInterval);
        }

        /// <summary>
        /// Returns true if EmailCampaignScheduleConfigChangeScheduleInterval instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailCampaignScheduleConfigChangeScheduleInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailCampaignScheduleConfigChangeScheduleInterval other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
