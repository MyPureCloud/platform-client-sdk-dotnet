...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EvaluationFormSearchResponse :  IEquatable<EvaluationFormSearchResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EvaluationFormSearchResponse);
        }

        /// <summary>
        /// Returns true if EvaluationFormSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of EvaluationFormSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvaluationFormSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
