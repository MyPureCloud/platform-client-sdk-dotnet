...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class QueueConversationEventTopicDispositionAmdTimeout : IEquatable<QueueConversationEventTopicDispositionAmdTimeout>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="QueueConversationEventTopicDispositionAmdTimeout" /> class.
		/// </summary>
		...
		public QueueConversationEventTopicDispositionAmdTimeout(long? TimeoutMs = null, string TimerStartEvent = null, double? TimerStartTime = null, double? TimerEndTime = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as QueueConversationEventTopicDispositionAmdTimeout);
		}

		/// <summary>
		/// Returns true if QueueConversationEventTopicDispositionAmdTimeout instances are equal
		/// </summary>
		/// <param name="other">Instance of QueueConversationEventTopicDispositionAmdTimeout to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(QueueConversationEventTopicDispositionAmdTimeout other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
