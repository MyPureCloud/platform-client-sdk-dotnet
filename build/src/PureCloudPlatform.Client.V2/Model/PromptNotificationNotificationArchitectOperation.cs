...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PromptNotificationNotificationArchitectOperation :  IEquatable<PromptNotificationNotificationArchitectOperation>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PromptNotificationNotificationArchitectOperation);
        }

        /// <summary>
        /// Returns true if PromptNotificationNotificationArchitectOperation instances are equal
        /// </summary>
        /// <param name="other">Instance of PromptNotificationNotificationArchitectOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PromptNotificationNotificationArchitectOperation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
