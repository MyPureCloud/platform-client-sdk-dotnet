...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationErrorInfo :  IEquatable<ConversationNotificationErrorInfo>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if ConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
