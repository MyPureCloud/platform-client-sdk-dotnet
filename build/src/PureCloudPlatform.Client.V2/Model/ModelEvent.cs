...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ModelEvent :  IEquatable<ModelEvent>
    {
        ...
        /// <param name="CustomerId">Primary identifier of the customer in the source of the events. (required).</param>
        /// <param name="CustomerIdType">Type of primary identifier (e.g. cookie, email, phone, salesforce). (required).</param>
        ...
        /// <param name="SegmentAssignedEvent">Event where a customer has been assigned or tagged with a specific segment..</param>
        ...
        /// <param name="CreatedDate">Timestamp indicating when the event actually took place. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ.</param>
        public ModelEvent(string Id = null, string CustomerId = null, string CustomerIdType = null, Session Session = null, string EventType = null, GenericActionEvent GenericActionEvent = null, OutcomeAchievedEvent OutcomeAchievedEvent = null, SegmentAssignedEvent SegmentAssignedEvent = null, WebActionEvent WebActionEvent = null, WebEvent WebEvent = null, DateTime? CreatedDate = null)
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>Type of primary identifier (e.g. cookie, email, phone, salesforce).</value>
        ...
        /// </summary>
        /// <value>Event where a customer has been assigned or tagged with a specific segment.</value>
        ...
        /// </summary>
        /// <value>Timestamp indicating when the event actually took place. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
