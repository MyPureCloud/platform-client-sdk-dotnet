...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class TestTopicPhraseTestPhraseMatchedTranscript : IEquatable<TestTopicPhraseTestPhraseMatchedTranscript>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TestTopicPhraseTestPhraseMatchedTranscript" /> class.
		/// </summary>
		...
		public TestTopicPhraseTestPhraseMatchedTranscript(long? Timestamp = null, string TranscriptId = null, string CommunicationId = null, string ConversationId = null, MediaTypeEnum? MediaType = null, List<TestTopicPhraseTestPhraseDetectedPhrase> DetectedPhrases = null)
		{
		...
		public List<TestTopicPhraseTestPhraseDetectedPhrase> DetectedPhrases { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class TestTopicPhraseTestPhraseMatchedTranscript {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as TestTopicPhraseTestPhraseMatchedTranscript);
		}

		/// <summary>
		/// Returns true if TestTopicPhraseTestPhraseMatchedTranscript instances are equal
		/// </summary>
		/// <param name="other">Instance of TestTopicPhraseTestPhraseMatchedTranscript to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(TestTopicPhraseTestPhraseMatchedTranscript other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
