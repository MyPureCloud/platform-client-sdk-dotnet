...
this.AlertTypes = AlertTypes;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InteractionStatRuleNotification);
        }

        /// <summary>
        /// Returns true if InteractionStatRuleNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of InteractionStatRuleNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InteractionStatRuleNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
