...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BuSchedulerSettingsRequest :  IEquatable<BuSchedulerSettingsRequest>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="BuSchedulerSettingsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BuSchedulerSettingsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BuSchedulerSettingsRequest" /> class.
        /// </summary>
        /// <param name="ConsistentServiceLevelSmoothing">Indicates whether to provide consistent service level smoothing in schedule generation for this business unit.</param>
        /// <param name="Metadata">Version metadata for this business unit&#39;s scheduler settings (required).</param>
        public BuSchedulerSettingsRequest(bool? ConsistentServiceLevelSmoothing = null, WfmVersionedEntityMetadata Metadata = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BuSchedulerSettingsRequest);
        }

        /// <summary>
        /// Returns true if BuSchedulerSettingsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of BuSchedulerSettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuSchedulerSettingsRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
