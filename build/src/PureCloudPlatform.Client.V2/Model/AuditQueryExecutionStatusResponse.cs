...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AuditQueryExecutionStatusResponse :  IEquatable<AuditQueryExecutionStatusResponse>
    {
        ...
        /// <param name="StartDate">Start date and time of the audit query execution. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ.</param>
        ...
        /// </summary>
        /// <value>Start date and time of the audit query execution. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
