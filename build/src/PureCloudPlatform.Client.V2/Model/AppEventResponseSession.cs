...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AppEventResponseSession :  IEquatable<AppEventResponseSession>
    {
        ...
        /// <param name="CreatedDate">Date of the session's first event, that is when the session starts. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
