...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationResponseSuggestionsTopicQueryReformulationContext :  IEquatable<ConversationResponseSuggestionsTopicQueryReformulationContext>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationResponseSuggestionsTopicQueryReformulationContext" /> class.
        /// </summary>
        /// <param name="KnowledgeClassification">KnowledgeClassification.</param>
        /// <param name="ReformulatedQuery">ReformulatedQuery.</param>
        public ConversationResponseSuggestionsTopicQueryReformulationContext(KnowledgeClassificationEnum? KnowledgeClassification = null, string ReformulatedQuery = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationResponseSuggestionsTopicQueryReformulationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationResponseSuggestionsTopicQueryReformulationContext);
        }

        /// <summary>
        /// Returns true if ConversationResponseSuggestionsTopicQueryReformulationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationResponseSuggestionsTopicQueryReformulationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationResponseSuggestionsTopicQueryReformulationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
