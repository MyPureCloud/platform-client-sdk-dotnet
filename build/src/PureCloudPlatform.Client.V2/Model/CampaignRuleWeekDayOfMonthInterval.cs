...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CampaignRuleWeekDayOfMonthInterval :  IEquatable<CampaignRuleWeekDayOfMonthInterval>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CampaignRuleWeekDayOfMonthInterval);
        }

        /// <summary>
        /// Returns true if CampaignRuleWeekDayOfMonthInterval instances are equal
        /// </summary>
        /// <param name="other">Instance of CampaignRuleWeekDayOfMonthInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignRuleWeekDayOfMonthInterval other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
