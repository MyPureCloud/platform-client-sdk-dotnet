...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CoachingScheduleSlotsJobSlot :  IEquatable<CoachingScheduleSlotsJobSlot>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoachingScheduleSlotsJobSlot" /> class.
        /// </summary>
        ...
        public CoachingScheduleSlotsJobSlot(DateTime? DateStart = null, CoachingScheduleSlotsJobSchedule Schedule = null)
        {
        ...
        public CoachingScheduleSlotsJobSchedule Schedule { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CoachingScheduleSlotsJobSlot);
        }

        /// <summary>
        /// Returns true if CoachingScheduleSlotsJobSlot instances are equal
        /// </summary>
        /// <param name="other">Instance of CoachingScheduleSlotsJobSlot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoachingScheduleSlotsJobSlot other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
