...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssistantCopilotVariation :  IEquatable<AssistantCopilotVariation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssistantCopilotVariation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssistantCopilotVariation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssistantCopilotVariation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssistantCopilotVariation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AssistantCopilotVariation);
        }

        /// <summary>
        /// Returns true if AssistantCopilotVariation instances are equal
        /// </summary>
        /// <param name="other">Instance of AssistantCopilotVariation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssistantCopilotVariation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
