...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class UserRoutingLanguagePost :  IEquatable<UserRoutingLanguagePost>
    {
        ...
        public UserRoutingLanguagePost(string Id = null, double? Proficiency = null)
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for UserRoutingLanguagePost and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Proficiency == null)
            {
                throw new InvalidDataException("Proficiency is a required property for UserRoutingLanguagePost and cannot be null");
            }
            else
            {
