...
{
    /// <summary>
    /// ConversationScriptSuggestionsTopicQueryReformulationContext
    /// </summary>
    [DataContract]
    public partial class ConversationScriptSuggestionsTopicQueryReformulationContext :  IEquatable<ConversationScriptSuggestionsTopicQueryReformulationContext>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationScriptSuggestionsTopicQueryReformulationContext" /> class.
        /// </summary>
        /// <param name="KnowledgeClassification">KnowledgeClassification.</param>
        /// <param name="ReformulatedQuery">ReformulatedQuery.</param>
        public ConversationScriptSuggestionsTopicQueryReformulationContext(KnowledgeClassificationEnum? KnowledgeClassification = null, string ReformulatedQuery = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationScriptSuggestionsTopicQueryReformulationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationScriptSuggestionsTopicQueryReformulationContext);
        }

        /// <summary>
        /// Returns true if ConversationScriptSuggestionsTopicQueryReformulationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationScriptSuggestionsTopicQueryReformulationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationScriptSuggestionsTopicQueryReformulationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
