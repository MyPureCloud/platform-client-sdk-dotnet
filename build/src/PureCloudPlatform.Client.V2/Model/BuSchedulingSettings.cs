...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class BuSchedulingSettings :  IEquatable<BuSchedulingSettings>
    {
        ...
        public BuSchedulingSettings(List<SchedulerMessageTypeSeverity> MessageSeverities = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BuSchedulingSettings);
        }

        /// <summary>
        /// Returns true if BuSchedulingSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of BuSchedulingSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuSchedulingSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
