...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class Reoccurrence :  IEquatable<Reoccurrence>
    {
        ...
        /// <param name="TimeZone">The time zone for the recurrence. The time zone of the recurrence is determined by prioritizing the recurrence's time zone if specified, then the schedule's time zone if set, and finally defaulting to UTC if neither defines a time zone. (required).</param>
        ...
        /// </summary>
        /// <value>The time zone for the recurrence. The time zone of the recurrence is determined by prioritizing the recurrence's time zone if specified, then the schedule's time zone if set, and finally defaulting to UTC if neither defines a time zone.</value>
