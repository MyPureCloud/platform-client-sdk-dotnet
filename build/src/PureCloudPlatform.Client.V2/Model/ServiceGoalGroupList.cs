...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceGoalGroupList :  IEquatable<ServiceGoalGroupList>
    {
        ...
        public List<ServiceGoalGroup> Entities { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ServiceGoalGroupList);
        }

        /// <summary>
        /// Returns true if ServiceGoalGroupList instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceGoalGroupList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceGoalGroupList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
