...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CaseManagementAsyncAggregationQuery :  IEquatable<CaseManagementAsyncAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseManagementAsyncAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaseManagementAsyncAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseManagementAsyncAggregationQuery" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CaseManagementAsyncAggregationQuery);
        }

        /// <summary>
        /// Returns true if CaseManagementAsyncAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of CaseManagementAsyncAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseManagementAsyncAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
