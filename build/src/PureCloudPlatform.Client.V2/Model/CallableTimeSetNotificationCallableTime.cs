...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CallableTimeSetNotificationCallableTime :  IEquatable<CallableTimeSetNotificationCallableTime>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallableTimeSetNotificationCallableTime);
        }

        /// <summary>
        /// Returns true if CallableTimeSetNotificationCallableTime instances are equal
        /// </summary>
        /// <param name="other">Instance of CallableTimeSetNotificationCallableTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallableTimeSetNotificationCallableTime other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
