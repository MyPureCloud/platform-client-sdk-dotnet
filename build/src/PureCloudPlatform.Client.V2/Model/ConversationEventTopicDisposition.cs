...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEventTopicDisposition :  IEquatable<ConversationEventTopicDisposition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEventTopicDisposition" /> class.
        /// </summary>
        ...
        public ConversationEventTopicDisposition(string Name = null, string Analyzer = null, ConversationEventTopicDispositionAmdTimeout AmdTimeout = null, ConversationEventTopicDispositionSilentCallTimeout SilentCallTimeout = null)
        {
            this.Name = Name;
        ...
        public ConversationEventTopicDispositionAmdTimeout AmdTimeout { get; set; }
        ...
        public ConversationEventTopicDispositionSilentCallTimeout SilentCallTimeout { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationEventTopicDisposition {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicDisposition);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicDisposition instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicDisposition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicDisposition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
