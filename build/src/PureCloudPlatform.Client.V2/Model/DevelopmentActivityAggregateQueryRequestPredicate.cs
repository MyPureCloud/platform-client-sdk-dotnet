...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class DevelopmentActivityAggregateQueryRequestPredicate :  IEquatable<DevelopmentActivityAggregateQueryRequestPredicate>
    {
        ...
        /// <param name="Value">Corresponding value for dimensions in predicates. If the dimension is type, Valid Values: Informational, AssessedContent, Assessment, Coaching, External (required).</param>
        ...
        /// </summary>
        /// <value>Corresponding value for dimensions in predicates. If the dimension is type, Valid Values: Informational, AssessedContent, Assessment, Coaching, External</value>
