...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class EdgeTrunkBase :  IEquatable<EdgeTrunkBase>
    {
        ...
        public EdgeTrunkBase(string Name = null, string Description = null, int? Version = null, DateTime? DateCreated = null, DateTime? DateModified = null, string ModifiedBy = null, string CreatedBy = null, StateEnum? State = null, string ModifiedByApp = null, string CreatedByApp = null, UriReference TrunkMetabase = null, Dictionary<string, Object> Properties = null, TrunkTypeEnum? TrunkType = null)
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for EdgeTrunkBase and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            {
                throw new InvalidDataException("TrunkMetabase is a required property for EdgeTrunkBase and cannot be null");
            }
            else
            {
            ...
            if (TrunkType == null)
            {
                throw new InvalidDataException("TrunkType is a required property for EdgeTrunkBase and cannot be null");
            }
            else
            {
