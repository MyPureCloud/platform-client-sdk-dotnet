...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class V2ConversationMessageTypingEventForUserTopicConversationContentActions :  IEquatable<V2ConversationMessageTypingEventForUserTopicConversationContentActions>
    {
        ...
        public V2ConversationMessageTypingEventForUserTopicConversationContentActions(string Url = null, string UrlTarget = null, string Textback = null)
        {
            this.Url = Url;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ConversationMessageTypingEventForUserTopicConversationContentActions);
        }

        /// <summary>
        /// Returns true if V2ConversationMessageTypingEventForUserTopicConversationContentActions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ConversationMessageTypingEventForUserTopicConversationContentActions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ConversationMessageTypingEventForUserTopicConversationContentActions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
