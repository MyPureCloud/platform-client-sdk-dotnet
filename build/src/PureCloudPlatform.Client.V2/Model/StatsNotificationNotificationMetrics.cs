...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatsNotificationNotificationMetrics :  IEquatable<StatsNotificationNotificationMetrics>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StatsNotificationNotificationMetrics);
        }

        /// <summary>
        /// Returns true if StatsNotificationNotificationMetrics instances are equal
        /// </summary>
        /// <param name="other">Instance of StatsNotificationNotificationMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatsNotificationNotificationMetrics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
