...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DecisionTableJobValidationError :  IEquatable<DecisionTableJobValidationError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecisionTableJobValidationError" /> class.
        /// </summary>
        ...
        /// <param name="RowNumber">Row number in the import file when applicable (1-based for data rows; 0 may be used for file-level issues such as headers).</param>
        public DecisionTableJobValidationError(string Message = null, string Code = null, int? Status = null, string EntityId = null, string EntityName = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<Detail> Details = null, List<ErrorBody> Errors = null, Limit Limit = null, int? RowNumber = null)
        {
        ...
        /// </summary>
        /// <value>Row number in the import file when applicable (1-based for data rows; 0 may be used for file-level issues such as headers)</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DecisionTableJobValidationError);
        }

        /// <summary>
        /// Returns true if DecisionTableJobValidationError instances are equal
        /// </summary>
        /// <param name="other">Instance of DecisionTableJobValidationError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecisionTableJobValidationError other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
