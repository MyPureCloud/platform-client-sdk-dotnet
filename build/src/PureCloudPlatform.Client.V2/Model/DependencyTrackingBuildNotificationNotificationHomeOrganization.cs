...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DependencyTrackingBuildNotificationNotificationHomeOrganization :  IEquatable<DependencyTrackingBuildNotificationNotificationHomeOrganization>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DependencyTrackingBuildNotificationNotificationHomeOrganization);
        }

        /// <summary>
        /// Returns true if DependencyTrackingBuildNotificationNotificationHomeOrganization instances are equal
        /// </summary>
        /// <param name="other">Instance of DependencyTrackingBuildNotificationNotificationHomeOrganization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DependencyTrackingBuildNotificationNotificationHomeOrganization other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
