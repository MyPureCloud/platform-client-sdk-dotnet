...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class IntradayPerformancePredictionAgentData :  IEquatable<IntradayPerformancePredictionAgentData>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayPerformancePredictionAgentData);
        }

        /// <summary>
        /// Returns true if IntradayPerformancePredictionAgentData instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayPerformancePredictionAgentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayPerformancePredictionAgentData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
