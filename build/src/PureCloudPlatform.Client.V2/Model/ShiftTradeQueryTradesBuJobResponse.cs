...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeQueryTradesBuJobResponse :  IEquatable<ShiftTradeQueryTradesBuJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeQueryTradesBuJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeQueryTradesBuJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeQueryTradesBuJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="QueryTradesResult">Results for QueryTrades job type.</param>
        public ShiftTradeQueryTradesBuJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, ShiftTradeListJobResponse QueryTradesResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
        ...
        /// </summary>
        /// <value>Results for QueryTrades job type</value>
        [DataMember(Name="queryTradesResult", EmitDefaultValue=false)]
        public ShiftTradeListJobResponse QueryTradesResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  QueryTradesResult: ").Append(QueryTradesResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeQueryTradesBuJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeQueryTradesBuJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeQueryTradesBuJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeQueryTradesBuJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.QueryTradesResult == other.QueryTradesResult ||
                    this.QueryTradesResult != null &&
                    this.QueryTradesResult.Equals(other.QueryTradesResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QueryTradesResult != null)
                    hash = hash * 59 + this.QueryTradesResult.GetHashCode();
