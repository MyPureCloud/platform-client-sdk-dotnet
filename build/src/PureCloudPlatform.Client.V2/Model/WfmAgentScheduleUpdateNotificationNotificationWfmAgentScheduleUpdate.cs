...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate :  IEquatable<WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate" /> class.
        /// </summary>
        /// <param name="UpdateType">UpdateType.</param>
        /// <param name="ShiftStartDates">ShiftStartDates.</param>
        public WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate(UpdateTypeEnum? UpdateType = null, List<DateTime?> ShiftStartDates = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate);
        }

        /// <summary>
        /// Returns true if WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmAgentScheduleUpdateNotificationNotificationWfmAgentScheduleUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
