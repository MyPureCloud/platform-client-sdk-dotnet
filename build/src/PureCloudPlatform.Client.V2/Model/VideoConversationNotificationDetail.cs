...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class VideoConversationNotificationDetail :  IEquatable<VideoConversationNotificationDetail>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VideoConversationNotificationDetail);
        }

        /// <summary>
        /// Returns true if VideoConversationNotificationDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of VideoConversationNotificationDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoConversationNotificationDetail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
