...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppleOpaqueId :  IEquatable<AppleOpaqueId>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AppleOpaqueId);
        }

        /// <summary>
        /// Returns true if AppleOpaqueId instances are equal
        /// </summary>
        /// <param name="other">Instance of AppleOpaqueId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleOpaqueId other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
