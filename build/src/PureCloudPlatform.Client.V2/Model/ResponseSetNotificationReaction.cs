...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseSetNotificationReaction :  IEquatable<ResponseSetNotificationReaction>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseSetNotificationReaction);
        }

        /// <summary>
        /// Returns true if ResponseSetNotificationReaction instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseSetNotificationReaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSetNotificationReaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
