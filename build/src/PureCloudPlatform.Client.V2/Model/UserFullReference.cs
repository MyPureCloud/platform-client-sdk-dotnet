...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserFullReference :  IEquatable<UserFullReference>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserFullReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserFullReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserFullReference" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserFullReference);
        }

        /// <summary>
        /// Returns true if UserFullReference instances are equal
        /// </summary>
        /// <param name="other">Instance of UserFullReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFullReference other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
