...
this.InteractingTimeSeconds = InteractingTimeSeconds;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationIntradayHistoricalAgentData);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationIntradayHistoricalAgentData instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationIntradayHistoricalAgentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationIntradayHistoricalAgentData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
