...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageConversationNotificationMessageMedia :  IEquatable<MessageConversationNotificationMessageMedia>
    {
...
this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageConversationNotificationMessageMedia);
        }

        /// <summary>
        /// Returns true if MessageConversationNotificationMessageMedia instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageConversationNotificationMessageMedia to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConversationNotificationMessageMedia other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
