...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationsExport :  IEquatable<OrganizationsExport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationsExport" /> class.
        /// </summary>
        ...
        public OrganizationsExport(List<string> DivisionIds = null, OrganizationsExportQueryConditions QueryConditions = null)
        {
        ...
        public OrganizationsExportQueryConditions QueryConditions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrganizationsExport);
        }

        /// <summary>
        /// Returns true if OrganizationsExport instances are equal
        /// </summary>
        /// <param name="other">Instance of OrganizationsExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationsExport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
