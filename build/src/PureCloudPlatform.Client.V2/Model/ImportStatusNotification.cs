...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportStatusNotification :  IEquatable<ImportStatusNotification>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportStatusNotification" /> class.
        /// </summary>
        ...
        public ImportStatusNotification(ImportStateEnum? ImportState = null, int? TotalRecords = null, int? CompletedRecords = null, int? PercentageComplete = null, string FailureReason = null, Object AdditionalProperties = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ImportStatusNotification);
        }

        /// <summary>
        /// Returns true if ImportStatusNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ImportStatusNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportStatusNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
