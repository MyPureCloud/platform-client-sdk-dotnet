...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationIntentSuggestionsTopicSuggestedIntentSlot :  IEquatable<ConversationIntentSuggestionsTopicSuggestedIntentSlot>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationIntentSuggestionsTopicSuggestedIntentSlot" /> class.
        /// </summary>
        /// <param name="SlotName">SlotName.</param>
        /// <param name="EntityType">EntityType.</param>
        /// <param name="SlotValue">SlotValue.</param>
        /// <param name="Probability">Probability.</param>
        public ConversationIntentSuggestionsTopicSuggestedIntentSlot(string SlotName = null, string EntityType = null, string SlotValue = null, double? Probability = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationIntentSuggestionsTopicSuggestedIntentSlot);
        }

        /// <summary>
        /// Returns true if ConversationIntentSuggestionsTopicSuggestedIntentSlot instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationIntentSuggestionsTopicSuggestedIntentSlot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationIntentSuggestionsTopicSuggestedIntentSlot other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
