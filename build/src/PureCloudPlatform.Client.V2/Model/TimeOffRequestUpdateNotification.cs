...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimeOffRequestUpdateNotification :  IEquatable<TimeOffRequestUpdateNotification>
    {
...
this.ModifiedBy = ModifiedBy;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TimeOffRequestUpdateNotification);
        }

        /// <summary>
        /// Returns true if TimeOffRequestUpdateNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of TimeOffRequestUpdateNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeOffRequestUpdateNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
