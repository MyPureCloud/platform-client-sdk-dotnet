...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class VideoConversationNotificationErrorBody :  IEquatable<VideoConversationNotificationErrorBody>
    {
        ...
        public VideoConversationNotificationErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<VideoConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public List<VideoConversationNotificationErrorBody> Errors { get; set; }
