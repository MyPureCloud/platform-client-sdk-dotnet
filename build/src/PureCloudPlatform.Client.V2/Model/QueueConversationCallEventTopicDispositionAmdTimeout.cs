...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationCallEventTopicDispositionAmdTimeout :  IEquatable<QueueConversationCallEventTopicDispositionAmdTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicDispositionAmdTimeout" /> class.
        /// </summary>
        ...
        public QueueConversationCallEventTopicDispositionAmdTimeout(long? TimeoutMs = null, string TimerStartEvent = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCallEventTopicDispositionAmdTimeout);
        }

        /// <summary>
        /// Returns true if QueueConversationCallEventTopicDispositionAmdTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCallEventTopicDispositionAmdTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCallEventTopicDispositionAmdTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
