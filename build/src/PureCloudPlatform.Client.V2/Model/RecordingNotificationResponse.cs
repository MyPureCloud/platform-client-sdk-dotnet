...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingNotificationResponse :  IEquatable<RecordingNotificationResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordingNotificationResponse" /> class.
        /// </summary>
        /// <param name="OriginatingMessageId">Reference to the ID of the original outbound notification message this response is for (e.g. the Apple requestIdentifier)..</param>
        ...
        /// <param name="NotificationStatus">The status of the notification response..</param>
        /// <param name="NotificationText">The localized display text of the user&#39;s response (e.g. \&quot;Yes\&quot;)..</param>
        public RecordingNotificationResponse(string OriginatingMessageId = null, string ReferenceId = null, NotificationStatusEnum? NotificationStatus = null, string NotificationText = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingNotificationResponse);
        }

        /// <summary>
        /// Returns true if RecordingNotificationResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingNotificationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingNotificationResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
