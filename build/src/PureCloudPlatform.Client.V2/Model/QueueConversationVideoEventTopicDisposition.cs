...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class QueueConversationVideoEventTopicDisposition : IEquatable<QueueConversationVideoEventTopicDisposition>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicDisposition" /> class.
		/// </summary>
		...
		public QueueConversationVideoEventTopicDisposition(string Name = null, string Analyzer = null, QueueConversationVideoEventTopicDispositionAmdTimeout AmdTimeout = null, QueueConversationVideoEventTopicDispositionSilentCallTimeout SilentCallTimeout = null)
		{
			this.Name = Name;
		...
		public QueueConversationVideoEventTopicDispositionAmdTimeout AmdTimeout { get; set; }
		...
		public QueueConversationVideoEventTopicDispositionSilentCallTimeout SilentCallTimeout { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as QueueConversationVideoEventTopicDisposition);
		}

		/// <summary>
		/// Returns true if QueueConversationVideoEventTopicDisposition instances are equal
		/// </summary>
		/// <param name="other">Instance of QueueConversationVideoEventTopicDisposition to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(QueueConversationVideoEventTopicDisposition other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
