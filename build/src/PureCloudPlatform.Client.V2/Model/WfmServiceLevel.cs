...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmServiceLevel :  IEquatable<WfmServiceLevel>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmServiceLevel);
        }

        /// <summary>
        /// Returns true if WfmServiceLevel instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmServiceLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmServiceLevel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
