...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Stage :  IEquatable<Stage>
    {
        /// <summary>
        /// The Status of the Stage.
        /// </summary>
        /// <value>The Status of the Stage.</value>
        ...
        /// <param name="DateCreated">The Stage creation date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
        /// <param name="DateModified">The Stage modification date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
        /// <param name="DateCompleted">The Stage completion date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
        /// <param name="DateStarted">The Stage start date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
        ...
        /// <param name="FailureReason">The reason the Stage failed, if applicable..</param>
        /// <param name="Case">The parent Case of the Stage..</param>
        public Stage(string Name = null, string Description = null, DateTime? DateCreated = null, DateTime? DateModified = null, DateTime? DateCompleted = null, DateTime? DateStarted = null, UserReference ModifiedBy = null, int? Version = null, StatusEnum? Status = null, FailureReason FailureReason = null, CaseReference Case = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The description of the Stage.</value>
        ...
        /// </summary>
        /// <value>The Stage creation date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z</value>
        ...
        /// </summary>
        /// <value>The Stage modification date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z</value>
        ...
        /// </summary>
        /// <value>The Stage completion date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z</value>
        ...
        /// </summary>
        /// <value>The Stage start date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z</value>
        ...
        /// </summary>
        /// <value>The ID of the User who modified the Stage.</value>
        ...
        /// </summary>
        /// <value>The version of the Stage.</value>
        ...
        /// </summary>
        /// <value>The reason the Stage failed, if applicable.</value>
        ...
        /// </summary>
        /// <param name="other">Instance of Stage to be compared</param>
        /// <returns>Boolean</returns>
