...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackConversationNotificationErrorInfo :  IEquatable<CallbackConversationNotificationErrorInfo>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackConversationNotificationErrorInfo" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallbackConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if CallbackConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
