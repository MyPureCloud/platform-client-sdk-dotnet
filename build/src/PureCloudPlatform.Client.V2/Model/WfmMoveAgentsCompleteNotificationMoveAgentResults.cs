...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmMoveAgentsCompleteNotificationMoveAgentResults :  IEquatable<WfmMoveAgentsCompleteNotificationMoveAgentResults>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmMoveAgentsCompleteNotificationMoveAgentResults" /> class.
        /// </summary>
        ...
        public WfmMoveAgentsCompleteNotificationMoveAgentResults(WfmMoveAgentsCompleteNotificationUser User = null, MoveAgentResultEnum? MoveAgentResult = null)
        {
...
this.MoveAgentResult = MoveAgentResult;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmMoveAgentsCompleteNotificationMoveAgentResults);
        }

        /// <summary>
        /// Returns true if WfmMoveAgentsCompleteNotificationMoveAgentResults instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmMoveAgentsCompleteNotificationMoveAgentResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmMoveAgentsCompleteNotificationMoveAgentResults other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
