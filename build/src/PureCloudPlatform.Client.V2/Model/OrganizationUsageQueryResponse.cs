...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class OrganizationUsageQueryResponse : IEquatable<OrganizationUsageQueryResponse>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="OrganizationUsageQueryResponse" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected OrganizationUsageQueryResponse() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="OrganizationUsageQueryResponse" /> class.
		/// </summary>
		...
		public OrganizationUsageQueryResponse(string Id = null, string Name = null, string ResultsUri = null)
		{
			this.Id = Id;
			this.Name = Name;
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as OrganizationUsageQueryResponse);
		}

		/// <summary>
		/// Returns true if OrganizationUsageQueryResponse instances are equal
		/// </summary>
		/// <param name="other">Instance of OrganizationUsageQueryResponse to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(OrganizationUsageQueryResponse other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
