...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationCobrowseEventTopicErrorBody :  IEquatable<QueueConversationCobrowseEventTopicErrorBody>
    {
        ...
        public QueueConversationCobrowseEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<QueueConversationCobrowseEventTopicDetail> Details = null, List<QueueConversationCobrowseEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
