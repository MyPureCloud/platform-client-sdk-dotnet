...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationSocialExpressionEventTopicWrapup :  IEquatable<QueueConversationSocialExpressionEventTopicWrapup>
    {
        ...
        public QueueConversationSocialExpressionEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, int? DurationSeconds = null, DateTime? EndTime = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
