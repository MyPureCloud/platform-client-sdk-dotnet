...
{
    /// <summary>
    /// SocialConversationNotificationDetail
    /// </summary>
    [DataContract]
    public partial class SocialConversationNotificationDetail :  IEquatable<SocialConversationNotificationDetail>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocialConversationNotificationDetail);
        }

        /// <summary>
        /// Returns true if SocialConversationNotificationDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of SocialConversationNotificationDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialConversationNotificationDetail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
