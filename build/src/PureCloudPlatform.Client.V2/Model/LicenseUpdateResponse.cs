...
this.Statuses = Statuses;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LicenseUpdateResponse);
        }

        /// <summary>
        /// Returns true if LicenseUpdateResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of LicenseUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LicenseUpdateResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
