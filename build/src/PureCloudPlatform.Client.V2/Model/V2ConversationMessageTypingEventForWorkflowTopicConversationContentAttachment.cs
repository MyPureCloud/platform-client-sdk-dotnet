...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment :  IEquatable<V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment>
    {
        ...
        public V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment(string Id = null, MediaTypeEnum? MediaType = null, string Url = null, string Mime = null, string Text = null, string Sha256 = null, string Filename = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment);
        }

        /// <summary>
        /// Returns true if V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
