...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout :  IEquatable<QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout" /> class.
        /// </summary>
        ...
        public QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout(long? TimeoutMs = null, double? TimerStartTime = null, double? TimerEndTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicDispositionSilentCallTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
