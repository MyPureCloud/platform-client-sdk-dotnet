...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmMoveAgentsCompleteNotificationResults :  IEquatable<WfmMoveAgentsCompleteNotificationResults>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmMoveAgentsCompleteNotificationResults" /> class.
        /// </summary>
...
this.Result = Result;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WfmMoveAgentsCompleteNotificationResults {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmMoveAgentsCompleteNotificationResults);
        }

        /// <summary>
        /// Returns true if WfmMoveAgentsCompleteNotificationResults instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmMoveAgentsCompleteNotificationResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmMoveAgentsCompleteNotificationResults other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
