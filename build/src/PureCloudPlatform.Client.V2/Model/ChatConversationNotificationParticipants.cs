...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChatConversationNotificationParticipants :  IEquatable<ChatConversationNotificationParticipants>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatConversationNotificationParticipants" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChatConversationNotificationParticipants {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChatConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if ChatConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of ChatConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
