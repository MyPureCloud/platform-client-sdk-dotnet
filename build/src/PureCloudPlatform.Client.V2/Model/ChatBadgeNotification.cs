...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChatBadgeNotification :  IEquatable<ChatBadgeNotification>
    {
        ...
        public ChatBadgeNotificationEntity Entity { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChatBadgeNotification);
        }

        /// <summary>
        /// Returns true if ChatBadgeNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ChatBadgeNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatBadgeNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
