...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WhatsAppIdentityResolutionConfig :  IEquatable<WhatsAppIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WhatsAppIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public WhatsAppIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WhatsAppIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if WhatsAppIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of WhatsAppIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WhatsAppIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
