...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallableTimeSetNotificationTimeSlots);
        }

        /// <summary>
        /// Returns true if CallableTimeSetNotificationTimeSlots instances are equal
        /// </summary>
        /// <param name="other">Instance of CallableTimeSetNotificationTimeSlots to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallableTimeSetNotificationTimeSlots other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
