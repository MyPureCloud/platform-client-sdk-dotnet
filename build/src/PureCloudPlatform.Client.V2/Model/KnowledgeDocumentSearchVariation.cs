...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KnowledgeDocumentSearchVariation :  IEquatable<KnowledgeDocumentSearchVariation>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentSearchVariation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KnowledgeDocumentSearchVariation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentSearchVariation" /> class.
        /// </summary>
        ...
        public KnowledgeDocumentSearchVariation(AddressableEntityRef DocumentVersion = null, List<DocumentVariationContext> Contexts = null, int? Priority = null, string Name = null, DocumentBodyWithHighlight Body = null, List<DocumentVariationSearchChunkBlock> Chunks = null)
        {
        ...
        public List<DocumentVariationSearchChunkBlock> Chunks { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KnowledgeDocumentSearchVariation);
        }

        /// <summary>
        /// Returns true if KnowledgeDocumentSearchVariation instances are equal
        /// </summary>
        /// <param name="other">Instance of KnowledgeDocumentSearchVariation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnowledgeDocumentSearchVariation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
