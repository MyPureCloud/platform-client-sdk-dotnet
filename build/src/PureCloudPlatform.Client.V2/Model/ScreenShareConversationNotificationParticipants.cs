...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScreenShareConversationNotificationParticipants :  IEquatable<ScreenShareConversationNotificationParticipants>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenShareConversationNotificationParticipants" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ScreenShareConversationNotificationParticipants);
        }

        /// <summary>
        /// Returns true if ScreenShareConversationNotificationParticipants instances are equal
        /// </summary>
        /// <param name="other">Instance of ScreenShareConversationNotificationParticipants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenShareConversationNotificationParticipants other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
