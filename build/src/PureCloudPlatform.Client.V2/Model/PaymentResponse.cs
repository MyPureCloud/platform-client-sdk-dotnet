...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class PaymentResponse :  IEquatable<PaymentResponse>
    {
        ...
        /// </summary>
        /// <param name="OriginatingMessageId">Reference to the ID of the original payment request message this response is for..</param>
        /// <param name="PaymentStatus">The status of the payment transaction..</param>
        /// <param name="FailureReason">The reason the payment request failed..</param>
        public PaymentResponse(string OriginatingMessageId = null, PaymentStatusEnum? PaymentStatus = null, string FailureReason = null)
        {
