...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SocialConversationNotificationErrorBody :  IEquatable<SocialConversationNotificationErrorBody>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocialConversationNotificationErrorBody" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SocialConversationNotificationErrorBody {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocialConversationNotificationErrorBody);
        }

        /// <summary>
        /// Returns true if SocialConversationNotificationErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of SocialConversationNotificationErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialConversationNotificationErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
