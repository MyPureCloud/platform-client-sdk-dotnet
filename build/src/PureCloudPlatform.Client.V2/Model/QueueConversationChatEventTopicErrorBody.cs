...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationChatEventTopicErrorBody :  IEquatable<QueueConversationChatEventTopicErrorBody>
    {
        ...
        public QueueConversationChatEventTopicErrorBody(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<QueueConversationChatEventTopicDetail> Details = null, List<QueueConversationChatEventTopicErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
