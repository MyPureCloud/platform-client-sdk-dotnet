...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationNotificationVideos :  IEquatable<ConversationNotificationVideos>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationVideos);
        }

        /// <summary>
        /// Returns true if ConversationNotificationVideos instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationVideos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationVideos other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
