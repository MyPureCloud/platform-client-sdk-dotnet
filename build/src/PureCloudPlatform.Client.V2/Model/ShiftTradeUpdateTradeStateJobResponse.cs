...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeUpdateTradeStateJobResponse :  IEquatable<ShiftTradeUpdateTradeStateJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeUpdateTradeStateJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeUpdateTradeStateJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeUpdateTradeStateJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="UpdateTradeStateResult">Results for UpdateTradeState job type.</param>
        public ShiftTradeUpdateTradeStateJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, BulkUpdateShiftTradeStateResultItem UpdateTradeStateResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
            ...
            this.Error = Error;
            this.UpdateTradeStateResult = UpdateTradeStateResult;
        ...
        /// <summary>
        /// Results for UpdateTradeState job type
        /// </summary>
        /// <value>Results for UpdateTradeState job type</value>
        [DataMember(Name="updateTradeStateResult", EmitDefaultValue=false)]
        public BulkUpdateShiftTradeStateResultItem UpdateTradeStateResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShiftTradeUpdateTradeStateJobResponse {\n");
            ...
            sb.Append("  UpdateTradeStateResult: ").Append(UpdateTradeStateResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeUpdateTradeStateJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeUpdateTradeStateJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeUpdateTradeStateJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeUpdateTradeStateJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.UpdateTradeStateResult == other.UpdateTradeStateResult ||
                    this.UpdateTradeStateResult != null &&
                    this.UpdateTradeStateResult.Equals(other.UpdateTradeStateResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UpdateTradeStateResult != null)
                    hash = hash * 59 + this.UpdateTradeStateResult.GetHashCode();
