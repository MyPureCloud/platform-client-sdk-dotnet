...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthoringKnowledgeSettings :  IEquatable<AuthoringKnowledgeSettings>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthoringKnowledgeSettings" /> class.
        /// </summary>
        ...
        /// <param name="InheritFromExternal">Whether to inherit knowledge settings from externalIf disabled, query detection is always enabled on the guide..</param>
        public AuthoringKnowledgeSettings(string KnowledgeId = null, string Description = null, KnowledgeTypeEnum? KnowledgeType = null, bool? InheritFromExternal = null)
        {
        ...
        /// </summary>
        /// <value>Whether to inherit knowledge settings from externalIf disabled, query detection is always enabled on the guide.</value>
        [DataMember(Name="inheritFromExternal", EmitDefaultValue=false)]
        public bool? InheritFromExternal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InheritFromExternal: ").Append(InheritFromExternal).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AuthoringKnowledgeSettings);
        }

        /// <summary>
        /// Returns true if AuthoringKnowledgeSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthoringKnowledgeSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthoringKnowledgeSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.InheritFromExternal == other.InheritFromExternal ||
                    this.InheritFromExternal != null &&
                    this.InheritFromExternal.Equals(other.InheritFromExternal)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InheritFromExternal != null)
                    hash = hash * 59 + this.InheritFromExternal.GetHashCode();
