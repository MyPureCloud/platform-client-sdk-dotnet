...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class SegmentAssignmentSession :  IEquatable<SegmentAssignmentSession>
    {
        ...
        /// </summary>
        /// <param name="Type">The type or category of session (e.g. web, ticket, delivery, atm)..</param>
        public SegmentAssignmentSession(string Type = null)
        {
            this.Type = Type;
        ...
        /// </summary>
        /// <value>The type or category of session (e.g. web, ticket, delivery, atm).</value>
