...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CreateOutboundMessagingConversationRequest :  IEquatable<CreateOutboundMessagingConversationRequest>
    {
        ...
        /// <param name="ToAddress">The messaging address of the recipient of the message. (required).</param>
        ...
        /// </summary>
        /// <value>The messaging address of the recipient of the message.</value>
