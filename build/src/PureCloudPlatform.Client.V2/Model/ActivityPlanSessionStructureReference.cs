...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ActivityPlanSessionStructureReference :  IEquatable<ActivityPlanSessionStructureReference>
    {
        ...
        /// </summary>
        /// <value>The list of users to delete from this session</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityPlanSessionStructureReference {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ActivityPlanSessionStructureReference);
        }

        /// <summary>
        /// Returns true if ActivityPlanSessionStructureReference instances are equal
        /// </summary>
        /// <param name="other">Instance of ActivityPlanSessionStructureReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityPlanSessionStructureReference other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
