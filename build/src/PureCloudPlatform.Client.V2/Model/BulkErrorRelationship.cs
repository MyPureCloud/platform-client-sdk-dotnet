...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class BulkErrorRelationship :  IEquatable<BulkErrorRelationship>
    {
        ...
        public BulkErrorRelationship(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, Relationship Entity = null, List<BulkErrorDetail> Details = null)
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkErrorRelationship);
        }

        /// <summary>
        /// Returns true if BulkErrorRelationship instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkErrorRelationship to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkErrorRelationship other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
