...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkEntityErrorContactList :  IEquatable<BulkEntityErrorContactList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkEntityErrorContactList" /> class.
        /// </summary>
        ...
        public BulkEntityErrorContactList(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, ContactList Entity = null)
        {
            this.Code = Code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkEntityErrorContactList {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkEntityErrorContactList);
        }

        /// <summary>
        /// Returns true if BulkEntityErrorContactList instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkEntityErrorContactList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkEntityErrorContactList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
