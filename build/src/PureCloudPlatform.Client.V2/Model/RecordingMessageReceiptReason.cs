...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class RecordingMessageReceiptReason : IEquatable<RecordingMessageReceiptReason>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="RecordingMessageReceiptReason" /> class.
		/// </summary>
		/// <param name="Code">The reason code for the failed message receipt.</param>
		/// <param name="Message">Description of the reason for the failed message receipt.</param>
		public RecordingMessageReceiptReason(CodeEnum? Code = null, string Message = null)
		{
			this.Code = Code;
		...
		public override string ToString()
		{
			...
			sb.Append("class RecordingMessageReceiptReason {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as RecordingMessageReceiptReason);
		}

		/// <summary>
		/// Returns true if RecordingMessageReceiptReason instances are equal
		/// </summary>
		/// <param name="other">Instance of RecordingMessageReceiptReason to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(RecordingMessageReceiptReason other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
