...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VideoConversationNotificationErrorInfo :  IEquatable<VideoConversationNotificationErrorInfo>
    {
...
this.Errors = Errors;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VideoConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if VideoConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of VideoConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
