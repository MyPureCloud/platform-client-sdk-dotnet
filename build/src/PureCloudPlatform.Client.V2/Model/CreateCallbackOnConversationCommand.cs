...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class CreateCallbackOnConversationCommand :  IEquatable<CreateCallbackOnConversationCommand>
    {
        ...
        public CreateCallbackOnConversationCommand(string ScriptId = null, string QueueId = null, RoutingData RoutingData = null, string CallbackUserName = null, List<string> CallbackNumbers = null, DateTime? CallbackScheduledTime = null, string CountryCode = null, Dictionary<string, string> Data = null)
        {
            ...
            {
                throw new InvalidDataException("CallbackNumbers is a required property for CreateCallbackOnConversationCommand and cannot be null");
            }
            else
            {
