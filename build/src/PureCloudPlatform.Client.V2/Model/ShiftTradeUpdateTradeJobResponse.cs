...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShiftTradeUpdateTradeJobResponse :  IEquatable<ShiftTradeUpdateTradeJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeUpdateTradeJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShiftTradeUpdateTradeJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShiftTradeUpdateTradeJobResponse" /> class.
        /// </summary>
        ...
        /// <param name="UpdateTradeResult">Results for UpdateTrade job type.</param>
        public ShiftTradeUpdateTradeJobResponse(string Id = null, StatusEnum? Status = null, TypeEnum? Type = null, string DownloadUrl = null, ErrorBody Error = null, ShiftTradeResponseItem UpdateTradeResult = null)
        {
            this.Id = Id;
            this.Status = Status;
            this.Type = Type;
            ...
            this.Error = Error;
            this.UpdateTradeResult = UpdateTradeResult;
        ...
        /// </summary>
        /// <value>Results for UpdateTrade job type</value>
        [DataMember(Name="updateTradeResult", EmitDefaultValue=false)]
        public ShiftTradeResponseItem UpdateTradeResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShiftTradeUpdateTradeJobResponse {\n");
            ...
            sb.Append("  UpdateTradeResult: ").Append(UpdateTradeResult).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShiftTradeUpdateTradeJobResponse);
        }

        /// <summary>
        /// Returns true if ShiftTradeUpdateTradeJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShiftTradeUpdateTradeJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShiftTradeUpdateTradeJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.UpdateTradeResult == other.UpdateTradeResult ||
                    this.UpdateTradeResult != null &&
                    this.UpdateTradeResult.Equals(other.UpdateTradeResult)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UpdateTradeResult != null)
                    hash = hash * 59 + this.UpdateTradeResult.GetHashCode();
