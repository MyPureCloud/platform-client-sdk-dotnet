...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChannelMetadata :  IEquatable<ChannelMetadata>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChannelMetadata);
        }

        /// <summary>
        /// Returns true if ChannelMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of ChannelMetadata to be compared</param>
        /// <returns>Boolean</returns>
