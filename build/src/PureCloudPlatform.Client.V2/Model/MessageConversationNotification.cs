...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageConversationNotification :  IEquatable<MessageConversationNotification>
    {
        ...
        public List<MessageConversationNotificationParticipants> Participants { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageConversationNotification);
        }

        /// <summary>
        /// Returns true if MessageConversationNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageConversationNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConversationNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
