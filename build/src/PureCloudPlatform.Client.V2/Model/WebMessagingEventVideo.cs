...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebMessagingEventVideo :  IEquatable<WebMessagingEventVideo>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebMessagingEventVideo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebMessagingEventVideo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebMessagingEventVideo" /> class.
        /// </summary>
        ...
        public WebMessagingEventVideo(TypeEnum? Type = null, string OfferingId = null, string Jwt = null)
        {
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WebMessagingEventVideo);
        }

        /// <summary>
        /// Returns true if WebMessagingEventVideo instances are equal
        /// </summary>
        /// <param name="other">Instance of WebMessagingEventVideo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebMessagingEventVideo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
