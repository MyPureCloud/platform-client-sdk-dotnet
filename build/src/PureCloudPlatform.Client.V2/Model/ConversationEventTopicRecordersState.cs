...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationEventTopicRecordersState : IEquatable<ConversationEventTopicRecordersState>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConversationEventTopicRecordersState" /> class.
		/// </summary>
		...
		public ConversationEventTopicRecordersState(string AdhocState = null, string CustomerExperienceState = null, string AgentExperienceState = null, string SnippetState = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationEventTopicRecordersState);
		}

		/// <summary>
		/// Returns true if ConversationEventTopicRecordersState instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationEventTopicRecordersState to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationEventTopicRecordersState other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
