...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Caseplan :  IEquatable<Caseplan>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Caseplan" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Caseplan);
        }

        /// <summary>
        /// Returns true if Caseplan instances are equal
        /// </summary>
        /// <param name="other">Instance of Caseplan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Caseplan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
