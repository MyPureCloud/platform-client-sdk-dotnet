...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntradayDataUpdateNotificationIntradayForecastData :  IEquatable<IntradayDataUpdateNotificationIntradayForecastData>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntradayDataUpdateNotificationIntradayForecastData" /> class.
        /// </summary>
        ...
        public IntradayDataUpdateNotificationIntradayForecastData(double? Offered = null, double? AverageTalkTimeSeconds = null, double? AverageAfterCallWorkSeconds = null)
        {
...
this.AverageAfterCallWorkSeconds = AverageAfterCallWorkSeconds;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IntradayDataUpdateNotificationIntradayForecastData);
        }

        /// <summary>
        /// Returns true if IntradayDataUpdateNotificationIntradayForecastData instances are equal
        /// </summary>
        /// <param name="other">Instance of IntradayDataUpdateNotificationIntradayForecastData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntradayDataUpdateNotificationIntradayForecastData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
