...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class InternalMessageConversation : IEquatable<InternalMessageConversation>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="InternalMessageConversation" /> class.
		/// </summary>
		...
		public InternalMessageConversation(string Name = null, List<InternalMessageMediaParticipant> Participants = null, List<string> OtherMediaUris = null, List<TransferResponse> RecentTransfers = null, string UtilizationLabelId = null, DateTime? InactivityTimeout = null, List<ConversationDivisionMembership> Divisions = null)
		{
			this.Name = Name;
		...
		public List<InternalMessageMediaParticipant> Participants { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class InternalMessageConversation {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as InternalMessageConversation);
		}

		/// <summary>
		/// Returns true if InternalMessageConversation instances are equal
		/// </summary>
		/// <param name="other">Instance of InternalMessageConversation to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(InternalMessageConversation other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
