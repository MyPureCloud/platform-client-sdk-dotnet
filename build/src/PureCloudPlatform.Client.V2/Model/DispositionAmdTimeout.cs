...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DispositionAmdTimeout :  IEquatable<DispositionAmdTimeout>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispositionAmdTimeout" /> class.
        /// </summary>
        ...
        public DispositionAmdTimeout(int? TimeoutMs = null, string TimerStartEvent = null, DateTime? TimerStartTime = null, DateTime? TimerEndTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DispositionAmdTimeout);
        }

        /// <summary>
        /// Returns true if DispositionAmdTimeout instances are equal
        /// </summary>
        /// <param name="other">Instance of DispositionAmdTimeout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DispositionAmdTimeout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
