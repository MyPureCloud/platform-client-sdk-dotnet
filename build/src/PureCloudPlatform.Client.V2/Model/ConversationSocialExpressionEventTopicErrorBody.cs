...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationSocialExpressionEventTopicErrorBody :  IEquatable<ConversationSocialExpressionEventTopicErrorBody>
    {
        ...
        public ConversationSocialExpressionEventTopicErrorBody(string Message = null, string Code = null, int? Status = null, string EntityId = null, string EntityName = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationSocialExpressionEventTopicDetail> Details = null, List<ConversationSocialExpressionEventTopicErrorBody> Errors = null)
        {
