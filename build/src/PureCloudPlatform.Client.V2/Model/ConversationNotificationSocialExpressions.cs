...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationNotificationSocialExpressions :  IEquatable<ConversationNotificationSocialExpressions>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationNotificationSocialExpressions" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationSocialExpressions);
        }

        /// <summary>
        /// Returns true if ConversationNotificationSocialExpressions instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationSocialExpressions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationSocialExpressions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
