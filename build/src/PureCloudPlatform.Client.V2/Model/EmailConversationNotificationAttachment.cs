...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailConversationNotificationAttachment :  IEquatable<EmailConversationNotificationAttachment>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailConversationNotificationAttachment);
        }

        /// <summary>
        /// Returns true if EmailConversationNotificationAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailConversationNotificationAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailConversationNotificationAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
