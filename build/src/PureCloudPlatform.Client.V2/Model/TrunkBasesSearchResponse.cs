...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrunkBasesSearchResponse :  IEquatable<TrunkBasesSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TrunkBasesSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrunkBasesSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrunkBasesSearchResponse" /> class.
        /// </summary>
        ...
        public TrunkBasesSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<TrunkBase> Results = null)
        {
            this.Total = Total;
        ...
        public List<TrunkBase> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrunkBasesSearchResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrunkBasesSearchResponse);
        }

        /// <summary>
        /// Returns true if TrunkBasesSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrunkBasesSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrunkBasesSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
