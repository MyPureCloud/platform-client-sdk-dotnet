...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RuleSetNotificationRule);
        }

        /// <summary>
        /// Returns true if RuleSetNotificationRule instances are equal
        /// </summary>
        /// <param name="other">Instance of RuleSetNotificationRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleSetNotificationRule other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
