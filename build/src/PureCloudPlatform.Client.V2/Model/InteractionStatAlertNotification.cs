...
this.AlertTypes = AlertTypes;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InteractionStatAlertNotification);
        }

        /// <summary>
        /// Returns true if InteractionStatAlertNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of InteractionStatAlertNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InteractionStatAlertNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
