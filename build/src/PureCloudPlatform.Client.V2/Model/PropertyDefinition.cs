...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	public partial class PropertyDefinition : IEquatable<PropertyDefinition>
	{
		...
		public PropertyDefinition(string Title = null, string Description = null, List<string> Type = null, string Pattern = null, string Format = null, Items Items = null, Dictionary<string, PropertyDefinition> Properties = null)
		{
			this.Title = Title;
		...
		/// </summary>
		/// <param name="other">Instance of PropertyDefinition to be compared</param>
		/// <returns>Boolean</returns>
