...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageConversationNotificationErrorBody :  IEquatable<MessageConversationNotificationErrorBody>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageConversationNotificationErrorBody" /> class.
        /// </summary>
...
this.Errors = Errors;
        ...
        public List<MessageConversationNotificationErrorBody> Errors { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageConversationNotificationErrorBody);
        }

        /// <summary>
        /// Returns true if MessageConversationNotificationErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageConversationNotificationErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConversationNotificationErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
