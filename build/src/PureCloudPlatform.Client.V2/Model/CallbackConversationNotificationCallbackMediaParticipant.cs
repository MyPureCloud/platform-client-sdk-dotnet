...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackConversationNotificationCallbackMediaParticipant :  IEquatable<CallbackConversationNotificationCallbackMediaParticipant>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackConversationNotificationCallbackMediaParticipant" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallbackConversationNotificationCallbackMediaParticipant);
        }

        /// <summary>
        /// Returns true if CallbackConversationNotificationCallbackMediaParticipant instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackConversationNotificationCallbackMediaParticipant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackConversationNotificationCallbackMediaParticipant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
