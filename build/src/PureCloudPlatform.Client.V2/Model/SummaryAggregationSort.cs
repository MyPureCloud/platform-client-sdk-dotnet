...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class SummaryAggregationSort : IEquatable<SummaryAggregationSort>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SummaryAggregationSort" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected SummaryAggregationSort() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="SummaryAggregationSort" /> class.
		/// </summary>
		...
		public SummaryAggregationSort(NameEnum? Name = null, FunctionEnum? Function = null)
		{
			this.Name = Name;
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as SummaryAggregationSort);
		}

		/// <summary>
		/// Returns true if SummaryAggregationSort instances are equal
		/// </summary>
		/// <param name="other">Instance of SummaryAggregationSort to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(SummaryAggregationSort other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
