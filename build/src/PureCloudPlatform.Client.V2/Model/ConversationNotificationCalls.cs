...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationNotificationCalls :  IEquatable<ConversationNotificationCalls>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationNotificationCalls);
        }

        /// <summary>
        /// Returns true if ConversationNotificationCalls instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationNotificationCalls to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationNotificationCalls other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
