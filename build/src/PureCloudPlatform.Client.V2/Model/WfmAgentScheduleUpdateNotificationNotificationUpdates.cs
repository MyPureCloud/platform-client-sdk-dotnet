...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WfmAgentScheduleUpdateNotificationNotificationUpdates :  IEquatable<WfmAgentScheduleUpdateNotificationNotificationUpdates>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfmAgentScheduleUpdateNotificationNotificationUpdates" /> class.
        /// </summary>
        /// <param name="UpdateType">UpdateType.</param>
        /// <param name="ShiftStartDates">ShiftStartDates.</param>
        public WfmAgentScheduleUpdateNotificationNotificationUpdates(UpdateTypeEnum? UpdateType = null, List<DateTime?> ShiftStartDates = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmAgentScheduleUpdateNotificationNotificationUpdates);
        }

        /// <summary>
        /// Returns true if WfmAgentScheduleUpdateNotificationNotificationUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmAgentScheduleUpdateNotificationNotificationUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmAgentScheduleUpdateNotificationNotificationUpdates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
