...
this.AdditionalProperties = AdditionalProperties;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CampaignSequenceNotification);
        }

        /// <summary>
        /// Returns true if CampaignSequenceNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of CampaignSequenceNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSequenceNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
