...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryWeekSummaryListJobRequest :  IEquatable<QueryWeekSummaryListJobRequest>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="QueryWeekSummaryListJobRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryWeekSummaryListJobRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryWeekSummaryListJobRequest" /> class.
        /// </summary>
        ...
        public QueryWeekSummaryListJobRequest(List<string> ManagementUnitIds = null, List<String> WeekDates = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryWeekSummaryListJobRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueryWeekSummaryListJobRequest);
        }

        /// <summary>
        /// Returns true if QueryWeekSummaryListJobRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of QueryWeekSummaryListJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryWeekSummaryListJobRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
