...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoogleBusinessProfileDataIngestionRuleVersionResponse :  IEquatable<GoogleBusinessProfileDataIngestionRuleVersionResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleBusinessProfileDataIngestionRuleVersionResponse" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GoogleBusinessProfileDataIngestionRuleVersionResponse);
        }

        /// <summary>
        /// Returns true if GoogleBusinessProfileDataIngestionRuleVersionResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GoogleBusinessProfileDataIngestionRuleVersionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleBusinessProfileDataIngestionRuleVersionResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
