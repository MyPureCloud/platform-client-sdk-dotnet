...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateShiftTradeRequest :  IEquatable<UpdateShiftTradeRequest>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShiftTradeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateShiftTradeRequest() { }
    
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShiftTradeRequest" /> class.
        /// </summary>
        /// <param name="ReceivingUserId">Update the ID of the receiving user to direct the request at a specific user, or set to null to open up a trade to be matched by any user.</param>
        /// <param name="Expiration">Update the expiration time for this shift trade. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ.</param>
        /// <param name="AcceptableIntervals">AcceptableIntervals.</param>
        /// <param name="Metadata">Version metadata (required).</param>
        public UpdateShiftTradeRequest(string ReceivingUserId = null, DateTime? Expiration = null, List<ShiftTradeResponseAcceptableIntervals> AcceptableIntervals = null, WfmVersionedEntityMetadata Metadata = null)
        {
        ...
        /// </summary>
        /// <value>Update the ID of the receiving user to direct the request at a specific user, or set to null to open up a trade to be matched by any user</value>
        ...
        /// </summary>
        /// <value>Update the expiration time for this shift trade. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateShiftTradeRequest);
        }

        /// <summary>
        /// Returns true if UpdateShiftTradeRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateShiftTradeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShiftTradeRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
