...
{
    /// <summary>
    /// SocialConversationNotificationErrorInfo
    /// </summary>
    [DataContract]
    public partial class SocialConversationNotificationErrorInfo :  IEquatable<SocialConversationNotificationErrorInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SocialConversationNotificationErrorInfo" /> class.
        /// </summary>
        ...
        public SocialConversationNotificationErrorInfo(int? Status = null, string Code = null, string EntityId = null, string EntityName = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null, List<SocialConversationNotificationErrorBody> Errors = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public List<SocialConversationNotificationErrorBody> Errors { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SocialConversationNotificationErrorInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocialConversationNotificationErrorInfo);
        }

        /// <summary>
        /// Returns true if SocialConversationNotificationErrorInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of SocialConversationNotificationErrorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialConversationNotificationErrorInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
