...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class ConversationScriptSuggestionsTopicSuggestionContext : IEquatable<ConversationScriptSuggestionsTopicSuggestionContext>
	{
		/// <summary>
		...
		public ConversationScriptSuggestionsTopicSuggestionContext(Guid? QueueId = null, MediaTypeEnum? MediaType = null, Guid? UserId = null, Guid? ExternalContactId = null, Guid? AssistantId = null, Guid? UtteranceId = null, string MessageId = null, string QueryStatement = null, string Language = null)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as ConversationScriptSuggestionsTopicSuggestionContext);
		}

		/// <summary>
		/// Returns true if ConversationScriptSuggestionsTopicSuggestionContext instances are equal
		/// </summary>
		/// <param name="other">Instance of ConversationScriptSuggestionsTopicSuggestionContext to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConversationScriptSuggestionsTopicSuggestionContext other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
