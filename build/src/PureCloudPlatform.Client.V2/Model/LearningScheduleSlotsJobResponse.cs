...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class LearningScheduleSlotsJobResponse : IEquatable<LearningScheduleSlotsJobResponse>
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LearningScheduleSlotsJobResponse" /> class.
		/// </summary>
		/// <param name="UserIds">The user IDs to fetch the slots for..</param>
		...
		public LearningScheduleSlotsJobResponse(List<string> UserIds = null, int? LengthInMinutes = null, string BusinessUnitId = null, string ActivityCodeId = null, SlotsTypeEnum? SlotsType = null, List<LearningScheduleSlotsJobResult> Results = null)
		{
		...
		/// </summary>
		/// <value>The user IDs to fetch the slots for.</value>
		...
		public List<LearningScheduleSlotsJobResult> Results { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as LearningScheduleSlotsJobResponse);
		}

		/// <summary>
		/// Returns true if LearningScheduleSlotsJobResponse instances are equal
		/// </summary>
		/// <param name="other">Instance of LearningScheduleSlotsJobResponse to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(LearningScheduleSlotsJobResponse other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
