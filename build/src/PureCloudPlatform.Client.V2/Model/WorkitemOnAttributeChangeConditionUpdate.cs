...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WorkitemOnAttributeChangeConditionUpdate :  IEquatable<WorkitemOnAttributeChangeConditionUpdate>
    {
        ...
        /// </summary>
        /// <value>The comparison operator used to evaluate the priority attribute against the value.</value>
        [JsonConverter(typeof(UpgradeSdkEnumConverter))]
        ...
        /// <param name="Operator">The comparison operator used to evaluate the priority attribute against the value..</param>
        ...
        public WorkitemOnAttributeChangeConditionUpdate(AttributeEnum? Attribute = null, string NewValue = null, string OldValue = null, OperatorEnum? Operator = null, int? Value = null)
        {
