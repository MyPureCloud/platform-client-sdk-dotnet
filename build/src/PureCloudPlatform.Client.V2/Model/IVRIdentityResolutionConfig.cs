...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IVRIdentityResolutionConfig :  IEquatable<IVRIdentityResolutionConfig>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="IVRIdentityResolutionConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IVRIdentityResolutionConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IVRIdentityResolutionConfig" /> class.
        /// </summary>
        ...
        public IVRIdentityResolutionConfig(WritableStarrableDivision Division = null, bool? ResolveIdentities = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IVRIdentityResolutionConfig);
        }

        /// <summary>
        /// Returns true if IVRIdentityResolutionConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of IVRIdentityResolutionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IVRIdentityResolutionConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
