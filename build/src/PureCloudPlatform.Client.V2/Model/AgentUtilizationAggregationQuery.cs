...
{
    /// <summary>
    /// AgentUtilizationAggregationQuery
    /// </summary>
    [DataContract]
    public partial class AgentUtilizationAggregationQuery :  IEquatable<AgentUtilizationAggregationQuery>
    {
        /// <summary>
        ...
        public enum MetricsEnum
        {
            ...
            /// <summary>
            /// Enum Oagentavailableutilization for "oAgentAvailableUtilization"
            /// </summary>
            [EnumMember(Value = "oAgentAvailableUtilization")]
            Oagentavailableutilization,
            
            /// <summary>
            /// Enum Oagentmaxutilization for "oAgentMaxUtilization"
            /// </summary>
            [EnumMember(Value = "oAgentMaxUtilization")]
            Oagentmaxutilization,
            
            /// <summary>
            /// Enum Oagentutilizationpercentage for "oAgentUtilizationPercentage"
            /// </summary>
            [EnumMember(Value = "oAgentUtilizationPercentage")]
            Oagentutilizationpercentage
        }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUtilizationAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentUtilizationAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUtilizationAggregationQuery" /> class.
        /// </summary>
        ...
        public AgentUtilizationAggregationQuery(string Interval = null, string Granularity = null, string TimeZone = null, List<GroupByEnum> GroupBy = null, AgentUtilizationAggregateQueryFilter Filter = null, List<MetricsEnum> Metrics = null, bool? FlattenMultivaluedDimensions = null, List<AgentUtilizationAggregationView> Views = null, AlternateTimeDimensionEnum? AlternateTimeDimension = null)
        {
        ...
        public AgentUtilizationAggregateQueryFilter Filter { get; set; }
        ...
        public List<AgentUtilizationAggregationView> Views { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentUtilizationAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentUtilizationAggregationQuery);
        }

        /// <summary>
        /// Returns true if AgentUtilizationAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentUtilizationAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentUtilizationAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
