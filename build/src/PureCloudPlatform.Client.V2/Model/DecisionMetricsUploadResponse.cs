...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DecisionMetricsUploadResponse :  IEquatable<DecisionMetricsUploadResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecisionMetricsUploadResponse" /> class.
        /// </summary>
        ...
        public DecisionMetricsUploadResponse(string UploadKey = null, string Url = null, Dictionary<string, string> Headers = null, DecisionMetricsUploadSchema UploadBodySchema = null)
        {
        ...
        public DecisionMetricsUploadSchema UploadBodySchema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecisionMetricsUploadResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DecisionMetricsUploadResponse);
        }

        /// <summary>
        /// Returns true if DecisionMetricsUploadResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DecisionMetricsUploadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecisionMetricsUploadResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
