...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RuleSetNotificationCondition :  IEquatable<RuleSetNotificationCondition>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RuleSetNotificationCondition);
        }

        /// <summary>
        /// Returns true if RuleSetNotificationCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of RuleSetNotificationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleSetNotificationCondition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
