...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class Email :  IEquatable<Email>
    {
        ...
        /// </summary>
        /// <value>Represents the timestamp when a parked conversation will resume.</value>
        [DataMember(Name="resumeTimestamp", EmitDefaultValue=false)]
        public long? ResumeTimestamp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResumeTimestamp: ").Append(ResumeTimestamp).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Email other)
        {
            ...
            return true &&
                ...
                (
                    this.ResumeTimestamp == other.ResumeTimestamp ||
                    this.ResumeTimestamp != null &&
                    this.ResumeTimestamp.Equals(other.ResumeTimestamp)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResumeTimestamp != null)
                    hash = hash * 59 + this.ResumeTimestamp.GetHashCode();
