...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateScheduleBid :  IEquatable<CreateScheduleBid>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduleBid" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateScheduleBid() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduleBid" /> class.
        /// </summary>
        ...
        /// <param name="BidWindowStartDate">The bid start date where agents start participating in schedule bidding relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd (required).</param>
        ...
        /// <param name="WeeksToSchedule">The number of weeks to generate schedule set through this bid (required).</param>
        ...
        public CreateScheduleBid(string Name = null, BuShortTermForecastWeekReference Forecast = null, String BidWindowStartDate = null, String BidWindowEndDate = null, String EffectiveDate = null, int? WeeksToSchedule = null, bool? EndOverridesAndRotations = null, AgentRankingTypeEnum? AgentRankingType = null, RankingTiebreakerTypeEnum? RankingTiebreakerType = null)
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateScheduleBid {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateScheduleBid);
        }

        /// <summary>
        /// Returns true if CreateScheduleBid instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateScheduleBid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateScheduleBid other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
