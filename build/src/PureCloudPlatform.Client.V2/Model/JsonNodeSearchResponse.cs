...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JsonNodeSearchResponse :  IEquatable<JsonNodeSearchResponse>
    {
        ...
        public JsonNodeSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, JsonNode Results = null, JsonNode Aggregations = null)
        {
            ...
            if (Total == null)
            {
                throw new InvalidDataException("Total is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
                this.Total = Total;
            ...
            if (PageCount == null)
            {
                throw new InvalidDataException("PageCount is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
            ...
            if (PageSize == null)
            {
                throw new InvalidDataException("PageSize is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
            ...
            if (PageNumber == null)
            {
                throw new InvalidDataException("PageNumber is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
            ...
            if (Types == null)
            {
                throw new InvalidDataException("Types is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
                this.Types = Types;
            ...
            if (Results == null)
            {
                throw new InvalidDataException("Results is a required property for JsonNodeSearchResponse and cannot be null");
            }
            else
            {
