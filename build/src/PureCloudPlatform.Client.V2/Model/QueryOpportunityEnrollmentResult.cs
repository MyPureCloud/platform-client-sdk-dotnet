...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryOpportunityEnrollmentResult :  IEquatable<QueryOpportunityEnrollmentResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOpportunityEnrollmentResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryOpportunityEnrollmentResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOpportunityEnrollmentResult" /> class.
        /// </summary>
        /// <param name="OpportunityId">The ID of the opportunity (required).</param>
        /// <param name="Agent">A reference to the agent who created the enrollment (required).</param>
        ...
        public QueryOpportunityEnrollmentResult(string OpportunityId = null, UserReference Agent = null, StatusEnum? Status = null, BuScheduleReference Schedule = null, SystemMessageCodeEnum? SystemMessageCode = null, string ReviewNote = null, DenialCodeEnum? DenialCode = null, QueryOpportunityEnrollmentMetadata Metadata = null)
        {
        ...
        /// </summary>
        /// <value>A reference to the agent who created the enrollment</value>
        ...
        public QueryOpportunityEnrollmentMetadata Metadata { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueryOpportunityEnrollmentResult);
        }

        /// <summary>
        /// Returns true if QueryOpportunityEnrollmentResult instances are equal
        /// </summary>
        /// <param name="other">Instance of QueryOpportunityEnrollmentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryOpportunityEnrollmentResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
