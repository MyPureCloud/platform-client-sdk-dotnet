...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationCallEventTopicFaxStatus :  IEquatable<ConversationCallEventTopicFaxStatus>
    {
        ...
        public ConversationCallEventTopicFaxStatus(string Direction = null, int? ExpectedPages = null, int? ActivePage = null, int? LinesTransmitted = null, int? BytesTransmitted = null, int? DataRate = null, int? PageErrors = null, int? LineErrors = null)
        {
