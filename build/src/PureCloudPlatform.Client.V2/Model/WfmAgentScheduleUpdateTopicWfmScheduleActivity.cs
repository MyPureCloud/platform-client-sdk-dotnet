...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmAgentScheduleUpdateTopicWfmScheduleActivity :  IEquatable<WfmAgentScheduleUpdateTopicWfmScheduleActivity>
    {
        ...
        public WfmAgentScheduleUpdateTopicWfmScheduleActivity(string ActivityCodeId = null, DateTime? StartDate = null, bool? CountsAsPaidTime = null, int? LengthInMinutes = null, string TimeOffRequestId = null, string Description = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmAgentScheduleUpdateTopicWfmScheduleActivity);
        }

        /// <summary>
        /// Returns true if WfmAgentScheduleUpdateTopicWfmScheduleActivity instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmAgentScheduleUpdateTopicWfmScheduleActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmAgentScheduleUpdateTopicWfmScheduleActivity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
