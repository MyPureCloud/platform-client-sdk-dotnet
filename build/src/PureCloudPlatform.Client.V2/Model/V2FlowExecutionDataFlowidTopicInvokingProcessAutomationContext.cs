...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext :  IEquatable<V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext" /> class.
        /// </summary>
        ...
        public V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext(string TriggerId = null, string TriggerName = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext);
        }

        /// <summary>
        /// Returns true if V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2FlowExecutionDataFlowidTopicInvokingProcessAutomationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
