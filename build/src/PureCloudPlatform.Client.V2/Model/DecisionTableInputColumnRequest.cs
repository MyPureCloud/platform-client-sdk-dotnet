...
namespace PureCloudPlatform.Client.V2.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class DecisionTableInputColumnRequest : IEquatable<DecisionTableInputColumnRequest>
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="DecisionTableInputColumnRequest" /> class.
		/// </summary>
		[JsonConstructorAttribute]
		protected DecisionTableInputColumnRequest() { }
		/// <summary>
		/// Initializes a new instance of the <see cref="DecisionTableInputColumnRequest" /> class.
		/// </summary>
		...
		public DecisionTableInputColumnRequest(DecisionTableColumnDefaultRowValue DefaultsTo = null, DecisionTableInputColumnExpression Expression = null)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class DecisionTableInputColumnRequest {\n");
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals(obj as DecisionTableInputColumnRequest);
		}

		/// <summary>
		/// Returns true if DecisionTableInputColumnRequest instances are equal
		/// </summary>
		/// <param name="other">Instance of DecisionTableInputColumnRequest to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(DecisionTableInputColumnRequest other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
